...
import com.force.librarybase.network.exception.ErrorType;
import com.force.librarybase.network.retrofit.HttpRequestListener;
import com.force.librarybase.network.retrofit.HttpResponse;
import com.force.librarybase.network.retrofit.RxActionManagerImpl;
 ...
 * @author hugh
 */
public abstract class HttpRxObserver<T extends HttpResponse> implements Observer<T>, HttpRequestListener {
