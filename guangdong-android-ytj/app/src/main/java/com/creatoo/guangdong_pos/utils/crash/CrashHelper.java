package com.creatoo.guangdong_pos.utils.crash;
...
public final class CrashHelper {
    ...
    private static Class<? extends Activity> guessBrowserActivityClass() {
        ...
        //Else, get the default activity
        /*if (resolvedActivityClass == null && activityAvailable(X5BrowserActivity.class)) {
            resolvedActivityClass = X5BrowserActivity.class;
        }*/
