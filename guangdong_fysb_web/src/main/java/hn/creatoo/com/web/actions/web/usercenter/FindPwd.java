...
public class FindPwd {
    ...
    public ModelAndView toFindPwd(HttpServletRequest request){
    ...
    public ModelAndView toFindPwd2(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
    ...
    public ModelAndView toFindPwd3(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
