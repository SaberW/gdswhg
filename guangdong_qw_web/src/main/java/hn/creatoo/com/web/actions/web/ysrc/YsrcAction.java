package hn.creatoo.com.web.actions.web.ysrc;
...
public class YsrcAction {
    ...
    public ModelAndView toYsrcIndex(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/ysrc/index");
    ...
    public ModelAndView toYsrcList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/ysrc/list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"人才列表",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/detail")
    public ModelAndView toYsrcDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/ysrc/detail");
