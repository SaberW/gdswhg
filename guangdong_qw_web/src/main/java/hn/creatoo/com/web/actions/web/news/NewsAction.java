package hn.creatoo.com.web.actions.web.news;
...
/**
 * Created by LENCON on 2017/11/14.
 */
@Controller
@RequestMapping(value = "/news")
public class NewsAction {//包装页面头部SEO信息
    private void setCommcontent(ModelAndView mv, String title, String desc, String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-群众文化资源平台-群文资讯";
    ...
    public ModelAndView toNewsList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/news/list");
    ...
    public ModelAndView toQwzyDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/news/detail");
