function renderMyList() {
    ...
    $('.container .zcbrand-list .lists ul li div.img').mouseover(function () {
        $(this).children('.title').stop(1, 0).fadeOut(1000);
        $(this).children('.detail').stop(1, 0).fadeIn(500);
    });
    $('.container .zcbrand-list .lists ul li div.img').mouseout(function () {
        $(this).children('.title').stop(1, 0).fadeIn(500);
        $(this).children('.detail').stop(1, 0).fadeOut(1000);
    });
}
...
function renderMyListForReading() {
    ...
    $('.list-3-type-1 .zcbrand-list .lists ul li div.img').mouseover(function () {
        $(this).children('.title').stop(1, 0).fadeOut(1000);
        $(this).children('.detail').stop(1, 0).fadeIn(500);
    });
    $('.list-3-type-1 .zcbrand-list .lists ul li div.img').mouseout(function () {
        $(this).children('.title').stop(1, 0).fadeIn(500);
        $(this).children('.detail').stop(1, 0).fadeOut(1000);
    });
}
