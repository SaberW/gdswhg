...
$(document).ready(function () {
  $('.openCurriculum').on('click',function(){
    ...
    $('#showbm').on('click', function(){
        ...
        var url = basePath+'/'+[[${cultsite}]]+"/agdpxyz/checkTrainApply.do?";
        ...
        $.ajax({
            ...
            success: function (resultCode) {
                if ("001" == resultCode) {
                    var loginUrl = basePath+'/'+[[${cultsite}]]+"/login";
                    ...
                    window.location.href=basePath+'/'+[[${cultsite}]]+"/agdpxyz/toTrainApply.do?trainId="+trainId;
				}
            }
        })
    })
