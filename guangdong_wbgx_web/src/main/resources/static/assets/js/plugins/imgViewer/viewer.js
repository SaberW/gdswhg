...
(function (global, factory) {
  ...
  var render = {
    ...
    initList: function initList() {
      ...
      forEach(this.images, function (image, i) {
        ...
        var dataDtl = image.getAttribute('data-dtl');
        var url = options.url;
        ...
        if (src || url) {
          items.push('<li>' + '<img' + (' src="' + (src || url) + '"') + ' role="button"' + ' data-action="view"' + (' data-index="' + i + '"') + (' data-original-url="' + (url || src) + '"') + (' alt="' + alt + '"') + ' data-dtl="'+dataDtl+'">' + '</li>');
        }
      });
  ...
  var methods = {
    ...
    view: function view() {
      ...
      var dataDtl = img.getAttribute('data-dtl');
  ...
  var Viewer = function () {
    ...
    createClass(Viewer, [{
      ...
      value: function build() {
        ...
        var imgDtl = viewer.querySelector('.' + NAMESPACE + '-imgDtl');
        ...
        addClass(imgDtl, !options.imgDtl ? CLASS_HIDE : getResponsiveClass(options.imgDtl));
