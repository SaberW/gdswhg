...
public class MyTrainAction {
    ...
    public ModelAndView toTrain(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ModelAndView modelAndView = new ModelAndView();
        request.setAttribute("cultsite",cultsite);
        modelAndView.setViewName("guangdong/userCenter/curriculum");
        this.setCommcontent(modelAndView,"课程列表",null,null);
        return modelAndView;
    }
}
