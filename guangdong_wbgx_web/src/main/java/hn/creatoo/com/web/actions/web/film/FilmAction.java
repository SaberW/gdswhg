package hn.creatoo.com.web.actions.web.film;
...
public class FilmAction {
    ...
    public ModelAndView toIndex(HttpServletRequest request){
        ...
        modelAndView.setViewName("/film/index");
    ...
    public ModelAndView toList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/film/styleList");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"影院列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/film/detail");
        this.setCommcontent(modelAndView,"影院详情",null,null);
        return modelAndView;
    }
}
