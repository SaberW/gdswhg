...
public class IndexAction {
    ...
    @RequestMapping(value = "/{cultsite}/index2")
    public ModelAndView toIndexMain(HttpServletRequest request,HttpSession session){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/guangdong/indexmain");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"首页",null,null);
        //System.out.println("========api.root:"+ ConfigUtils.getApiConfig().getRoot()+"==============================================");
        return modelAndView;
    }
    @RequestMapping(value = "/{cultsite}/index3")
    public ModelAndView toIndexNEW(HttpServletRequest request,HttpSession session){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/guangdong/indexNew");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"首页",null,null);
        //System.out.println("========api.root:"+ ConfigUtils.getApiConfig().getRoot()+"==============================================");
        return modelAndView;
    ...
    public ModelAndView toContact(HttpServletRequest request,HttpSession session){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/guangdong/contact");
        request.setAttribute("qh",true);
