...
public class MyActivityAction {
    ...
    public ModelAndView toActivity(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ModelAndView modelAndView = new ModelAndView();
        request.setAttribute("cultsite",cultsite);
        modelAndView.setViewName("guangdong/userCenter/activity");
