package hn.creatoo.com.web.actions.web.feiyi;
...
public class FeiyiAction {
    ...
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-非遗中心";
    ...
    public ModelAndView toFeiYi(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/feiyi/feiyi_index");
        this.setCommcontent(modelAndView,"非遗首页",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/feiyi/list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"非遗列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/feiyi/detail");
        this.setCommcontent(modelAndView,"非遗详情",null,null);
        return modelAndView;
    }
}
