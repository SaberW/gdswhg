package hn.creatoo.com.web.actions.web.serviceAlliance;
...
public class ServiceAction {
    ...
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-服务联盟";
    ...
    public ModelAndView toList(HttpServletRequest request){
        ...
        modelAndView.setViewName("/servicealliance/servicealliance");
        this.setCommcontent(modelAndView,"图片详情",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/union")
    public ModelAndView toUnion(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        request.setAttribute("qh",true);
        modelAndView.setViewName("/servicealliance/union");
        this.setCommcontent(modelAndView,"公共文化",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toZxList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        request.setAttribute("qh",true);
        modelAndView.setViewName("/servicealliance/list");
        this.setCommcontent(modelAndView,"公共文化",null,null);
        return modelAndView;
    }
