...
public class PxAction {
    ...
    public ModelAndView toPxList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/px_list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"培训资源列表",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/detail")
    public ModelAndView toPxDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/train/detail");
        this.setCommcontent(modelAndView,"培训资源详情",null,null);
        return modelAndView;
    }
