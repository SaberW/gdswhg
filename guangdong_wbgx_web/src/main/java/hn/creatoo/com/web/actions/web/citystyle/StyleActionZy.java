...
public class StyleActionZy {
    ...
    public ModelAndView toResList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/cityStyle/resList");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"特色资源列表",null,null);
        return modelAndView;
    }
