...
public class CommInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        String yuMing = ConfigUtils.getApiConfig().getYuMing();//域名
        ...
        request.setAttribute( "yuMing",yuMing);

        //设置接口API
        Map<String, Object> jsonObject = new HashMap<String, Object>();
        jsonObject.put("rootUrl",rootUrl);
        ...
        jsonObject.put("actTag",rootUrl + "api/comm/getTags"); //标签查询 POST
        ...
        jsonObject.put("checkPreAct",rootUrl + "api/activity/checkPreAct"); //跳入活动预订页面之前的检查
        ...
        jsonObject.put("showStarts",rootUrl+"api/inside/delivery/showStarts"); //供需指数 星星展示
        jsonObject.put("showMemo",rootUrl+"api/inside/delivery/showMemo"); //加载说明
        ...
        jsonObject.put("myMessage",rootUrl + "api/message/list"); //获取我的消息 POST
        jsonObject.put("deleteMessage",rootUrl + "api/message/remove"); //删除消息 POST
        ...
        jsonObject.put("deleteCollect",rootUrl + "api/collection/delMyColle"); //删除收藏 POST
        ...
        jsonObject.put("searchPop",rootUrl+"/api/pop/search4List");//获取热门资源
        jsonObject.put("activityList",rootUrl+"api/activity/list");//获取热门活动
        jsonObject.put("infomationList",rootUrl+"api/information/infolist");//获取最新资讯
        jsonObject.put("ppList",rootUrl+"api/whpp/pplist");//获取活动品牌
        jsonObject.put("venueList",rootUrl+"api/venue/indexList");//获取热门场馆
        ...
        jsonObject.put("ipGetAddr",rootUrl+"api/comm/getAddr");//ip获取地区
        //外供-数字展厅
        jsonObject.put("digitalList",rootUrl+"api/digitalExhibition/list");//获取展厅列表
        jsonObject.put("digitalDetail",rootUrl+"api/digitalExhibition/detail");//获取展厅详情
        ...
        jsonObject.put("resHdList",rootUrl+"api/inside/activity/list");//获取活动列表
        jsonObject.put("resHdInfo",rootUrl+"api/inside/activity/info");//获取活动列表
        jsonObject.put("activityRecommends",rootUrl+"api/inside/activity/recommends");//推荐活动列表
        ...
        jsonObject.put("cultdetail",rootUrl+"api/whglm/whgdetail");//获取文化馆详情

        jsonObject.put("whglmList",rootUrl+"/api/whglm/whglmList");//获取文化馆联盟

        jsonObject.put("pplist",rootUrl+"api/whpp/pplist");//获取文化品牌列表
        jsonObject.put("ppdetail",rootUrl+"api/whpp/ppdetail");//获取文化品牌详情
        jsonObject.put("ppnews",rootUrl+"api/comm/glzx");//获取文化品牌资讯
        jsonObject.put("ppActList",rootUrl+"api/whpp/ppActList");//获取文化品牌关联活动列表
        jsonObject.put("resourceList",rootUrl+"api/comm/resource");//获取关联资源列表，/1图片/2视频/3音频/4文档
        jsonObject.put("ppResourceList",rootUrl+"/api/whpp/ppResourceList");//获取文化品牌关联资源列表，/1图片/2视频/3音频/4文档
        ...
        jsonObject.put("addDelivery4callback",rootUrl+"api/inside/delivery/addDelivery4callback");//申请配送
        ...
        jsonObject.put("sendMessage",rootUrl+"api/inside/msg/sendMessage");//发送站内信
        ...
        //大首页接口
        jsonObject.put("bannerActList",rootUrl+"api/bigbanner/bannerActList");//大首页活动推荐
        jsonObject.put("phbzs",rootUrl+"api/bigbanner/phbzs");//排行榜指数
        jsonObject.put("activeFG",rootUrl+"api/bigbanner/activeFG");//活跃分馆
        jsonObject.put("venueIndexList",rootUrl+"api/venue/indexList");//获取热门场馆
        jsonObject.put("TrainIndexList",rootUrl+"api/px/list");//获取热门培训

        jsonObject.put("yjpzList",rootUrl+"api/comm/yjpz");//硬件配置
        jsonObject.put("pxryList",rootUrl+"api/inside/tra/pxry");//硬件配置
        jsonObject.put("jmdList",rootUrl+"api/inside/showGoods/jmd");//节目单
        jsonObject.put("awardsList",rootUrl+"/api/inside/awards");//获奖情况

        jsonObject.put("descriptionList",rootUrl+"/api/inside/showGoods/ycjg");//获奖情况

        jsonObject.put("xgzxList",rootUrl+"/api/comm/glzx");//先关资讯
        jsonObject.put("showDelivery",rootUrl+"api/inside/delivery/showDelivery");//获取供给信息


        jsonObject.put("province","广东省");//设置省份

        jsonObject.put("myvisitnote", rootUrl+"static/admin/js/pc.js?type=1");

        /*jsonObject.put("infoldetail",rootUrl+"api/information/infoldetail");//获取资讯详情*/

        //api/information/infolist
        ///api/information/infoldetail
        ///api/information/infcolumn
        ///api/information/infolist
