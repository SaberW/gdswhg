package hn.creatoo.com.web.actions.web.digitalpavilion;
...
public class PavilionAction {
    ...
    public ModelAndView toIndex(HttpServletRequest request){
        ...
        modelAndView.setViewName("/shuzizhanguan/index");
    ...
    public ModelAndView toList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/shuzizhanguan/list");
    ...
    public ModelAndView toDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/shuzizhanguan/detail");
        this.setCommcontent(modelAndView,null,null,null);
        return modelAndView;
    }
}
