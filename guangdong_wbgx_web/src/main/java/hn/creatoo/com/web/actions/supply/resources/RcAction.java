...
public class RcAction {
    ...
    public ModelAndView toRcList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/rc_list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"人才资源列表",null,null);
        return modelAndView;
    }


    @RequestMapping(value = "/detail")
    public ModelAndView toRcDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/person/detail");
        this.setCommcontent(modelAndView,"人才资源列表",null,null);
        return modelAndView;
    }
}
