package hn.creatoo.com.web.actions.web.volunteer;
...
public class volunteerAction {
    ...
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-志愿者";
    ...
    public ModelAndView toIndex(HttpServletRequest request){
        ...
        this.setCommcontent(modelAndView,"志愿者首页",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/volunteer/list");
        this.setCommcontent(modelAndView,"志愿者列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/volunteer/detail");
        this.setCommcontent(modelAndView,"志愿者详情",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toLiuCheng(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/volunteer/baomingliucheng");
