package hn.creatoo.com.web.actions.web.tickets;
...
/**
 * Created by zengrong on 2017/7/10.
 */
@Controller
...
public class TicketsAction {
    ...
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-取票机";
    ...
    public ModelAndView toTickets(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/tickets/index");
        this.setCommcontent(modelAndView,"取票",null,null);
        return modelAndView;
    }
}
