...
public class SsAction {
    ...
    public ModelAndView toSsList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/ss_list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"设施资源列表",null,null);
        return modelAndView;
    }


    @RequestMapping(value = "/detail")
    public ModelAndView toSsDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/facilities/detail");
        this.setCommcontent(modelAndView,"设施资源列表",null,null);
        return modelAndView;
    }
}
