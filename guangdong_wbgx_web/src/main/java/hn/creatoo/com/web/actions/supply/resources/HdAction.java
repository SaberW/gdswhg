...
public class HdAction {
    ...
    public ModelAndView toCgList(HttpServletRequest request){
        ...
        modelAndView.setViewName("guangdong_gx/resources/hd_list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"活动资源列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toCgDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/activity/detail");
        this.setCommcontent(modelAndView,"活动资源详情",null,null);
        return modelAndView;
    }
}
