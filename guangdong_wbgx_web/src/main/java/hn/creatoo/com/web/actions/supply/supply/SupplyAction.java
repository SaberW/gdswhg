package hn.creatoo.com.web.actions.supply.supply;
...
public class SupplyAction {
    ...
    public ModelAndView toSupplyList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/supply/supplylist");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"供需列表",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/detail")
    public ModelAndView toSupplyDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/supply/detail");
        this.setCommcontent(modelAndView,"供需详情",null,null);
        return modelAndView;
    }
}
