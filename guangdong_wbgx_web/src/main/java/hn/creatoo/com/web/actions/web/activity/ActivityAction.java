package hn.creatoo.com.web.actions.web.activity;
 ...
 */
@Controller
@RequestMapping(value = "/{cultsite}/hd")
public class ActivityAction {
    ...
    public ModelAndView toList(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ...
        modelAndView.setViewName("guangdong/activity/list");
    ...
    public ModelAndView toDetail(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/activity/detail");
        request.setAttribute("cultsite",cultsite);
    ...
    public ModelAndView toActLiuCheng(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/activity/step");
        request.setAttribute("cultsite",cultsite);
        this.setCommcontent(modelAndView,"报名流程",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView live(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/activity/live");
        request.setAttribute("cultsite",cultsite);
        request.setAttribute("id", request.getParameter("id"));
        this.setCommcontent(modelAndView,"活动直播",null,null);
        return modelAndView;
    }
}
