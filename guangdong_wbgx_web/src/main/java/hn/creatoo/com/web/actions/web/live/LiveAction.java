package hn.creatoo.com.web.actions.web.live;
...
public class LiveAction {
    ...
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-直播";
    ...
    public ModelAndView toLiveIndex(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/live/index");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"直播列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/live/list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"直播列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/live/detail");
        this.setCommcontent(modelAndView,"直播详情",null,null);
        return modelAndView;
    }
}
