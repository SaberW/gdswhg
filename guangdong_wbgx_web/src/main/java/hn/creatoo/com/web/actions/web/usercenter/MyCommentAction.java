...
public class MyCommentAction {
    ...
    public ModelAndView toFavorite(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ModelAndView modelAndView = new ModelAndView();
        request.setAttribute("cultsite",cultsite);
        modelAndView.setViewName("guangdong/userCenter/comment");
        this.setCommcontent(modelAndView,"点评列表",null,null);
        return modelAndView;
    }
}
