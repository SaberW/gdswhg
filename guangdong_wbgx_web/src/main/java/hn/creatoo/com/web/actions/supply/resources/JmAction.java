 ...
 */
@Controller
@RequestMapping(value = "/res-jm")
public class JmAction {
    //包装页面头部SEO信息
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-演出节目";
    ...
    public ModelAndView toJmList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/jm_list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"节目资源列表",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/detail")
    public ModelAndView toJmDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/resources/program/detail");
        this.setCommcontent(modelAndView,"节目资源详情",null,null);
        return modelAndView;
    }
