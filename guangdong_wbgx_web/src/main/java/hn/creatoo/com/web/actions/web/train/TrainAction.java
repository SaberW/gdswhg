...
public class TrainAction {
    ...
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-培训";
    ...
    public ModelAndView toIndex(HttpServletRequest request){
        ...
        modelAndView.setViewName("guangdong/train/train");
        this.setCommcontent(modelAndView,"培训首页",null,null);
        return modelAndView;
    }*/
    ...
    public ModelAndView toList(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/train/trainlist");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"培训列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/train/traindetail");
        this.setCommcontent(modelAndView,"培训详情",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/step1st")
    public ModelAndView toStep1st(HttpServletRequest request){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/train/baomingliucheng");
        this.setCommcontent(modelAndView,"报名流程-第一步",null,null);
        return modelAndView;
    }
}