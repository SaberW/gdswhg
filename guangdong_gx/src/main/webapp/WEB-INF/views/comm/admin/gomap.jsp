    ...
    function whgMapInit() {
        ...
        AMap.plugin(['AMap.ToolBar', 'AMap.Autocomplete', 'AMap.PlaceSearch'],
            function () {
                ...
                AMap.event.addListener(placeSearch, "markerClick", function(e){
                    document.getElementById("lnglatX").value = e.data.location.lng;
                    document.getElementById("lnglatY").value = e.data.location.lat;
                });
            }
        );
        ...
        if(tipinput != null){
            ...
            function placeSearch2(){
                ...
                placeSearch.search(document.getElementById("tipinput").value, function(status, result) {
