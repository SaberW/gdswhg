...
<body>
    <table id="whgdg" class="easyui-datagrid" title="预定管理-${title}" style="display: none;"
        ...
        <thead>
            <tr>
                ...
                <th data-options="sortable: true, field:'state', formatter:function(v){return v==1?'有效':'无效'}">状态</th>
    ...
    <div id="tb" style="display: none;">
        ...
        <div style="padding-top: 5px">
            ...
            <input class= "easyui-combobox" name="state" data-options="width:80, panelHeight:'auto', data:[{value:'1',text:'有效'},{value:'0',text:'无效'}]" prompt="状态"/>
