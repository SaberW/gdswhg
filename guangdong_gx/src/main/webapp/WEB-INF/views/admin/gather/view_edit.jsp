...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>众筹单位：</div>
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="gat_company" value="${info.gat_company}" style="width:600px; height:32px"
                   data-options="required:true,validType:['length[1,200]'], prompt:'请输入众筹单位'">
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-combobox" style="width:245px; height:32px" name="gat_cultid" id="cultid" data-options="editable:false,required:true" />
            <input class="easyui-combobox" style="width:245px; height:32px" name="gat_deptid" id="deptid" data-options="editable:false,required:true" />
        </div>
    </div>
    <div class="whgff-row">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="gat_explains" id="gat_explains" value="${info.gat_explains}" prompt="请补充说明，字数限制在500个字符内"
                   multiline="true" required="true" validType="length[1,500]" style="width:600px; height:150px"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="gat_notice" id="gat_notice" value="${info.gat_notice}" prompt="固定内容，供需修改"
                   multiline="true" required="true" validType="length[1,500]" style="width:600px; height:200px"/>
        </div>
    </div>
    ...
    <div class="whgff-row  whgff-row-split">
        ...
        <div class="whgff-row-input">
            <div class="checkbox checkbox-primary whg-js-data" name="gat_noticetype" value="${info.gat_noticetype}"
...
<div id="module-other" style="display: none;">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="EEE-textbox" name="gat_phone" value="${info.gat_phone}" style="width:500px; height:32px"
                   data-options="validType:'length[1,60]',prompt:'请填写联系电话'">
        </div>
    </div>
    <div class="whgff-row">
...
<div id="module-act" style="display: none;">
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red"></label>相关活动：</div>
        <div class="whgff-row-input">
            <input class="EEE-combobox"   validType="notQuotes"
                   data-options="multiple:true, editable:true
                   ,onChange: function (val, oldval) {
                        if (val.length>1 && val[0]==''){
                        }
                    }"  style="width:500px; height:32px" name="gat_relateactid" id="gat_relateactid" />
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="checkbox checkbox-primary" id="XXXetag" name="etag"></div>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="EEE-combobox" id="ekey" name="ekey" style="width:500px; height:32px" validType="notQuotes"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input type="text" class="EEE-datebox" style="width: 240px; height: 32px;" id="XXXstarttime"
            ...
            <div id="free-time-set">
                <div id="put-ticket-list" style="width: 800px;">
                    <div class="ticket-item activityTimeLabel1">
                        <input class="EEE-timespinner" style="width: 100px; height: 32px;" value="${not empty info.playstime?info.playstime:'08:00'}" id="playstrtime" name="playstrtime" data-options="required:true"/>-
                        <input class="EEE-timespinner" style="width: 100px; height: 32px;" value="${not empty info.playetime?info.playetime:'10:00'}" id="playendtime" name="playendtime" data-options="required:true"/>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="EEE-numberbox" name="actlon" id="actlon" value="${info.actlon}"
                   style="width: 100px; height: 32px"
                   data-options="required:true, precision:6,readonly:true,prompt:'X轴'">
            <input class="EEE-numberbox" name="actlat" id="actlat" value="${info.actlat}"
                   style="width: 100px; height: 32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="radio radio-primary whg-js-data" name="integral" id="integral" value="${info.integral }"  onclick="ActTool.isIntegral()"
                 js-data='[{"id":"1","text":"否"},{"id":"2","text":"是"}]'>
...
<div id="module-tar" style="display: none;">
        ...
        <div class="whgff-row">
            <div class="whgff-row-label"><label style="color: red"></label>相关培训：</div>
            <div class="whgff-row-input">
                <input class="EEE-combobox" data-options="multiple:true, editable:true" style="width:500px; height:32px" name="gat_relatetraid" id="gat_relatetraid" />
            </div>
        </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="EEE-numberbox" id="longitude" name="longitude" value="${info.longitude}"
                   style="width:100px; height:32px" data-options="required:true,precision:6,readonly:true,prompt:'X轴'">
            <input class="EEE-numberbox" id="latitude" name="latitude" value="${info.latitude}"
                   style="width:100px; height:32px" data-options="required:true,precision:6,readonly:true,prompt:'y轴'">
...
<c:choose>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div id="catalog" name="_catalog" type="text/plain" style="width:600px; height:300px;"></div>
...
<script>
    ...
    $(function(){
        ...
        showXjReason('${id}', '${info.gat_state}', $("#whgff"));
    });
...
3、由于紧急事件、突发气候变化等不可预测因素造成众筹活动无法开展，发起人有权终止众筹活动，且不承担任何法律和经济责任。');
        ...
        edit: function(){
            ...
            if(state == 6 || state == 4) {
                $("#gat_nummin").numberbox("readonly", true);
                $('#gat_timestart').datetimebox("readonly", true);
                $('#gat_timeend').datetimebox("readonly", true);
            }
                ...
                onSubmit: function (param) {
                    ...
                    if(gatherType==4) {//活动
                        ...
                        $.each(list, function (index, value) {
                            ...
                            var item = {};
                            item.playstime = playstrtime;
                            item.playetime = playendtime;
        ...
        validata: function (param) {
            ...
            var noticetype = $("[name='gat_noticetype']:checkbox:checked");
            if (!noticetype || !noticetype.length){
    ...
    var ActTool = {
        ...
        initBuder: function () {
            ...
            WhgComm.initPMS({
                ...
                deptEid:'deptid', deptValue:'${info.gat_deptid}',
                ...
                actEid:'gat_relateactid', actValue:'${info.gat_relateactid}',bmEnd:false,
                roomEid:'roomid', roomValue:'${info.roomid}'

                ,provinceEid:'province', provinceValue:'${info.gat_province}',
                cityEid:'__CITY_ELE', cityValue:'${info.gat_city}',
                areaEid:'__AREA_ELE', areaValue:'${info.gat_area}'
            });
        },
        ...
        edit: function(){
            ...
            if(state == 6 || state == 4){
                $('#playstrtime').timespinner({readonly: true});
                $('#playendtime').timespinner({readonly: true});

                //$("#venueid").combobox({readonly: true});
                //$("#roomid").combobox({readonly: true});
                setTimeout(function () {
                    $("#venueid").combobox("readonly");
                    $("#roomid").combobox("readonly");
                }, 2000);
                $('#enterstrtime').datetimebox({ readonly: true});
                $('#starttime').datebox({readonly: true});
                $('#enterendtime').datetimebox({ readonly: true});
                $('#whgff').find("input[type='radio'][name='sellticket']").attr('readonly', true);
                $('#whgff').find("input[type='radio'][name='integral']").attr('readonly', true);
            }
        },
    ...
    var TarTool = {
        initBuder: function () {
            ...
            WhgComm.initPMS({
                ...
                traEid:'gat_relatetraid', traValue:'${info.gat_relatetraid}',bmEnd:false,
