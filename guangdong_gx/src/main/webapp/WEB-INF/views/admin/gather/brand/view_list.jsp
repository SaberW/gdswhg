...
<div id="whgdg-opt" style="display: none;">
    ...
    <a plain="true" method="whgListTool.viewGathers">查看项目列表</a>
    <a plain="true" method="whgListTool.resource">查看资源</a>
    ...
    <shiro:hasPermission name="${resourceid}:info"><a class="easyui-linkbutton" plain="true" validFun="validInfo" method="info">资讯公告管理</a></shiro:hasPermission>
...
<script>
    function validInfo(idx) {
        var row = $("#whgdg").datagrid("getRows")[idx];
        var pageType = "${pageType}";
        if(pageType == 'listedit'){
            return row.state == 1;
        }else if(pageType == 'listcheck'){
            return row.state == 9;
        }else if(pageType == 'listpublish'){
    ...
    $(function(){
        ...
        WhgComm.search('#whgdg', '#tb', '${basePath}/admin/brand/srchList?pageType=${pageType}');
    });
    ...
    Gridopts.prototype.resource = function(idx) {
        ...
        //WhgComm.editDialog('${basePath}/admin/resource/view/list?isbrand=1&reftype=29&refid=' + row.id+'&cultid='+cultid);
        WhgComm.editDialog('${basePath}/admin/mass/resmanage/view/list?refid=' + row.id+'&reftype=29');
    };
