...
<div data-options="region:'center',title:'站点培训统计列表'">
    <!-- 表格 -->
    <table id="whgdg" class="easyui-datagrid" style="display: none"
        ...
        <tr>
            ...
            <th data-options="field:'acts', width:100, sortable:true">培训总数</th>
            <th data-options="field:'tickettotal', width:100, sortable:true">总学位数</th>
            <th data-options="field:'ticketorder', width:100, sortable:true">总报名数</th>
            ...
            <th data-options="field:'ratebook', width:100, sortable:true">总报名率(%)</th>
            <th data-options="field:'rateseat', width:100, sortable:true">总签到率(%)</th>
        </tr>
        </thead>
    </table>
    <!-- 表格 END -->
...
<script type="text/javascript">
        ...
        WhgCommAreaTree.initAreaTree({
            ...
            onSelect: function(node, firstLevel, areaInfo){
                if(typeof(node.iscult) != 'undefined' && node.iscult == '1'){//选择文化馆
                    ...
                    WhgComm.search('#whgdg', '#whgdg-tb', '${basePath}/admin/tongji/bi/zdpx');
                }else{//选择省市区
                    $('#cultId').val('');
                    //$('#cultName').textbox('clear');
    ...
    function loadSuccess() {
        ...
        var total_ticketvalidtotal = compute("ticketvalidtotal");
        var ratebook = '0.0';
        var rateseat = '0.0';
        if(total_tickettotal != '0'){
            ratebook = ((total_ticketorder / total_tickettotal) * 100).toFixed(2);
            rateseat = ((total_ticketvalid / total_ticketvalidtotal) * 100).toFixed(2);
        }
        ...
        $('#whgdg').datagrid('appendRow', {
            ...
            'ticketvalidtotal': '<span class="subtotal">' + total_ticketvalidtotal + '</span>',
