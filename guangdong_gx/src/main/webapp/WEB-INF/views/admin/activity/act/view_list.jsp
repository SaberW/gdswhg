...
<!-- 表格 -->
<table id="whgdg" title="活动列表" class="easyui-datagrid" style="display: none"
...
<div id="whgdg-opt" style="display: none;">
    ...
    <c:choose>
        <c:when test="${type eq 'editList'}">
            <shiro:hasPermission name="${resourceid}:edit"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                              plain="true" validKey="state" validVal="1"
                                                              method="doEdit">编辑</a>
            ...
            <shiro:hasPermission name="${resourceid}:checkgo"> <a href="javascript:void(0)" class="easyui-linkbutton"
                                                                  plain="true" validFun="validSend"
                                                                  method="doCheckgo">送审</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:ccmanager"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                                   plain="true" validFun="validSend"
                                                                   method="doUpdateScreenings">场次管理</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:ziyuan"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                                plain="true" validKey="state" validVal="1"
                                                                method="doResource">资源管理</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:info"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                              plain="true" validKey="state" validVal="1"
                                                              method="info">资讯公告管理</a></shiro:hasPermission>
        ...
        <c:when test="${type eq 'check'}">
            <shiro:hasPermission name="${resourceid}:edit"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                              plain="true" validKey="state" validVal="9"
                                                              method="doEdit">编辑</a>
        ...
        <c:when test="${type eq 'publish'}">
            ...
            <shiro:hasPermission name="${resourceid}:ccmanager"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                                   plain="true" validKey="state" validVal="2,4"
                                                                   method="doUpdateScreenings">场次管理</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:order"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                               plain="true" validKey="state" validVal="4,6"
                                                               method="doOrder">订单管理</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:info"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                              plain="true" validKey="state" validVal="2,4,6"
                                                              method="info">资讯公告管理</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:ziyuan"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                                plain="true" validKey="state" validVal="2,4,6"
                                                                method="doResource">资源管理</a></shiro:hasPermission>

            <shiro:hasPermission name="${resourceid}:recommend"> <a href="javascript:void(0)" class="easyui-linkbutton"
                                                                    plain="true" validFun="validRecommendOn"
                                                                    method="doCommend">推荐</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:recommendoff"> <a href="javascript:void(0)"
                                                                       class="easyui-linkbutton" plain="true"
                                                                       validFun="validRecommendOff" method="commendOff">撤销推荐</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:bigbannered"> <a href="javascript:void(0)"
                                                                      class="easyui-linkbutton" plain="true"
                                                                      validFun="validBannerOn" method="doBigBanner">推荐上大首页</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:bigbanneroff"> <a href="javascript:void(0)"
                                                                       class="easyui-linkbutton" plain="true"
                                                                       validFun="validBannerOff" method="bigBannerOff">取消上大首页</a></shiro:hasPermission>
        ...
        <c:when test="${type eq 'del'}">
            ...
            <shiro:hasPermission name="${resourceid}:undel"> <a href="javascript:void(0)" class="easyui-linkbutton"
                                                                plain="true"
                                                                method="reBack">还原</a></shiro:hasPermission>
        </c:when>
    </c:choose>
</div>
<!-- 操作按钮-END -->
...
<script type="text/javascript">
    ...
    function setSmsGroup(idx){
        ...
        var url = '${basePath}/admin/yunwei/aliysmsgroup/refuse/view/edit?enttype=4&entid='+row.id;
            ...
            onOpen: function () {
                ...
                $('#whgff').form({
                    ...
                    onSubmit : function(param) {
                        ...
                        //param.fromState = "2,4";
                        param.toState = 6;
                        param.publishdate = $(".statemdfdate").datetimebox('getValue');
    ...
    function doResource(idx) {
        ...
        WhgComm.editDialog('${basePath}/admin/mass/resmanage/view/list?refid=' + curRow.id+'&reftype=4');
    }
