...
<body>
    ...
    <div id="whgdg-opt" style="display: block;">
        <shiro:hasPermission name="${resourceid}:resend"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" method="">重发短信</a></shiro:hasPermission>
        <shiro:hasPermission name="${resourceid}:resend"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" method="">重发站内信</a></shiro:hasPermission>
    </div>
    <script type="text/javascript">
        ...
        function getRowBtn(value,rowData,rowIndex) {
            ...
            if(rowData.ticketstatus == 1 && rowData.orderisvalid == 1 && rowData.endtime > rowData.nowDate){
            	 html += "<a href='javascript:void(0);' class='easyui-linkbutton' style='margin-right: 10px' onclick='againSendSms("+rowIndex+")' >重发短信</a>";
            }
            if(rowData.ticketstatus == 1 && rowData.orderisvalid == 1 && rowData.endtime > rowData.nowDate){
                html += "<a href='javascript:void(0);' class='easyui-linkbutton' style='margin-right: 10px' onclick='againSendZnx("+rowIndex+")' >重发站内信</a>";
            }
