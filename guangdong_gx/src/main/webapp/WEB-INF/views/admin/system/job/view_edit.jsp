...
<form id="whgff" class="whgff" method="post">
    ...
    <input type="hidden" name="onlyshow" value="${param.onlyshow == '1'}"/>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="name" value="${job.name}" style="width:500px; height:32px" data-options="prompt:'请输入岗位名称，最多允许30个字符', required:true, validType:'length[3,30]'"></div>
    </div>
...
<script type="text/javascript">
    ...
    function initForm() {
        $('#whgff').form({
            novalidate: true,
            url : getFullUrl('/admin/system/job/edit'),
