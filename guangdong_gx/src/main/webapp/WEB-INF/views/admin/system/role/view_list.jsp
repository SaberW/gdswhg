...
<body>
<!-- 表格 -->
<table id="whgdg" title="角色管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', queryParams:{cultid: WhgComm.getMgrCultsAndChild()[0].id}, url:'${basePath}/admin/system/role/srchList4p'">
    <thead>
    <tr>
        <th data-options="field:'ck', checkbox:true"></th>
        <th data-options="field:'name', width:100">名称</th>
        <th data-options="field:'cultid', width:80, formatter:WhgComm.FMTCult">文化馆</th>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        <form id="whgdg-tb-srch-form">
            ...
            <input class="easyui-combobox" style="width: 200px;" name="cultid" data-options="prompt:'请选择文化馆', editable:false, value:WhgComm.getMgrCultsAndChild()[0].id, valueField:'id', textField:'text', data:WhgComm.getMgrCultsAndChild()"/>
...
<div id="whgdg-opt" style="display: none;">
    ...
    <shiro:hasPermission name="${resourceid}:on">  <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="state" validVal="1" method="doCopy">复制</a></shiro:hasPermission>
...
<script type="text/javascript">
    ...
    function doCopy(idx) {
        var curRow = $('#whgdg').datagrid('getRows')[idx];
        WhgComm.editDialog('${basePath}/admin/system/role/view/copy?id='+curRow.id);
    }
