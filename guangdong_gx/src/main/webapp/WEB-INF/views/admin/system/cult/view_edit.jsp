...
<head>
    <meta charset="UTF-8">
    <title>${param.onlyshow == '1'?'查看文化馆':'编辑文化馆'}</title>
...
<form id="whgff" class="whgff" method="post">
    ...
    <h2>${param.onlyshow == '1'?'查看文化馆':'编辑文化馆'}</h2>

    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>文化馆名称：</div>
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="name" value="${cult.name}" style="width:500px; height:32px" data-options="required:true, prompt:'子馆名称，最多30个字符', validType:'length[3,30]'">
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="cultsite" value="${cult.cultsite}" style="width:500px; height:32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <a class="easyui-linkbutton easyui-linkbutton-formbtn" id="getXYPointBtn" text="选择坐标"></a>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="radio radio-primary whg-js-data" name="isshow" value="${cult.isshow}" js-data='[{"id":"1", "text":"是"},{"id":"0", "text":"否"}]'></div>
        </div>
    </div>
    ...
    <div class="whgff-row" style="display: none">
        ...
        <div class="whgff-row-input">
            ...
            <div class="whgff-row-input-imgfile">
                <i><a href="javascript:void(0)" class="easyui-linkbutton easyui-linkbutton-formbtn" iconCls="icon-save" id="imgUploadBtn3">选择图片</a></i>
    ...
    <div class="whgff-row" style="display: none">
        ...
        <div class="whgff-row-input">
            ...
            <div class="whgff-row-input-imgfile">
                <i><a href="javascript:void(0)" class="easyui-linkbutton easyui-linkbutton-formbtn" iconCls="icon-save" id="imgUploadBtn4">选择图片</a></i>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <div class="whgff-row-input-imgfile">
                <i><a href="javascript:void(0)" class="easyui-linkbutton easyui-linkbutton-formbtn" iconCls="icon-save" id="imgUploadBtn1">选择图片</a></i>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="telephone" value="${cult.telephone}" style="width:500px; height:32px" data-options="prompt:'请输入固定电话', required:true, validType:'isTel'"></div>
    </div>

    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>身份证号码：</div>
        <div class="whgff-row-input"><input class="easyui-textbox" name="idcard" value="${cult.idcard}" style="width:500px; height:32px" data-options="prompt:'请输入身份证号码', required:true, validType:'isIdcard'"></div>
    </div>

    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>身份证正面：</div>
        <div class="whgff-row-input">
            <input type="hidden" id="cult_idcardface" name="idcardface" value="${cult.idcardface}">
            <div class="whgff-row-input-imgview" id="idcardface" style="height: 200px;"></div>
            <div class="whgff-row-input-imgfile">
                <i><a href="javascript:void(0)" class="easyui-linkbutton easyui-linkbutton-formbtn" iconCls="icon-save" id="imgidcardface">选择图片</a></i>
                <i>图片格式为jpg、png、gif，建议图片尺寸 750*500，大小为2MB以内</i>
            </div>
        </div>
    </div>
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input type="hidden" id="cult_idcardback" name="idcardback" value="${cult.idcardback}">
            <div class="whgff-row-input-imgview" id="idcardback" style="height: 200px;"></div>
            <div class="whgff-row-input-imgfile">
                <i><a href="javascript:void(0)" class="easyui-linkbutton easyui-linkbutton-formbtn" iconCls="icon-save" id="imgidcardback">选择图片</a></i>
                <i>图片格式为jpg、png、gif，建议图片尺寸 750*500，大小为2MB以内</i>
            </div>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <input class="easyui-textbox" name="introduction" id="introduction" style="width:600px; height:250px" data-options="required:true, multiline:true, validType:['length[1,500]', 'isText']">
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    function myChangeProvince(newVal, oldVal){
        changeProvince(newVal, oldVal, function(){
            if(typeof(window.__init_city) == 'undefined'){
                $('#__CITY_ELE').combobox('setValue', '${cult.city}');
    ...
    function myChangeCity(newVal, oldVal){
        changeCity(newVal, oldVal, function(){
            if(typeof(window.__init_area) == 'undefined'){
                $('#__AREA_ELE').combobox('setValue', '${cult.area}');
        ...
        $('#whgff').form({
            ...
            success : function(data) {
                ...
                if(Json && Json.success == '1'){
                    if('${param.onlyshow}' == '1')window.parent.$('#whgdg').datagrid('reload');
    ...
    $(function () {
        ...
        WhgUploadImg.init({allowUpload:allowUpload, basePath: '${basePath}', uploadBtnId: 'imgUploadBtn1', hiddenFieldId: 'cult_picture1', previewImgId: 'previewImg1'});
        /*WhgUploadImg.init({allowUpload:allowUpload, basePath: '
        ...
        WhgUploadImg.init({allowUpload:allowUpload, basePath: '${basePath}', uploadBtnId: 'imgUploadBtn4', hiddenFieldId: 'cult_picture4', previewImgId: 'previewImg4', needCut:true, cutWidth:166, cutHeight:35,isSingleSy:false});
         */
        WhgUploadImg.init({
        ...
        //初始级别和区域
        initLevelAndArea('${cult.province}', '${cult.city}', '${cult.area}', '${cult.level}');

        //上级文化馆
        window.setTimeout(function(){$('#pid').combobox('setValue', '${cult.pid}');},800);

        //初始前端菜单
        initFrontMenu('${cult.frontmenu}');
        ...
        if('${param.onlyshow}' == "1"){
            window.setTimeout(function(){
                ...
                $('.easyui-linkbutton-formbtn').linkbutton('disable');
                $('.whgff-but-submit').hide();
            },1500);
        }
    });
</script>
