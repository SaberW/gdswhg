...
<table id="whgdg" title="管理员管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:true, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', queryParams:{cultid:WhgComm.getMgrCultsFirstId()}, url:'${basePath}/admin/system/user/srchList4p?admintype=bizmgr'">
    <thead>
    <tr>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-combobox" style="width: 200px;" id="cultid" name="cultid" data-options="prompt:'请选择文化馆',readonly:true, value:WhgComm.getMgrCultsFirstId(), valueField:'id', textField:'text', data:WhgComm.getMgrCults()"/>
...
<script type="text/javascript">
    ...
    function doAdd() {
        ...
        WhgComm.editDialog('${basePath}/admin/system/user/view/add?admintype=bizmgr&isbizmgr=0&cultid='+WhgComm.getMgrCultsFirstId()+'&cultname='+encodeURIComponent(cultname));
    }
