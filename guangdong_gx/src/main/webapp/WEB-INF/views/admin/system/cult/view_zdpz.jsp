...
<table id="whgdg" title="子馆管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', queryParams:{id: WhgComm.getMgrCults()[0].id},  url:'${basePath}/admin/system/cult/srchList4p'">
    <thead>
    <tr>
        ...
        <th data-options="field:'state', width:160, formatter:WhgComm.FMTBizState">状态</th>
...
<div id="whgdg-tb" style="display: none;">
    <div class="whgd-gtb-btn">
        <form id="whgdg-tb-srch-form">
            ...
            <input class="easyui-combobox" style="width: 200px;" name="id" data-options="required:true, prompt:'请选择文化馆', value:WhgComm.getMgrCults()[0].id, valueField:'id', textField:'text', data:WhgComm.getMgrCults()"/>
...
<script type="text/javascript">
    ...
    function doEdit(idx) {
        ...
        WhgComm.editDialog('${basePath}/admin/system/cult/view/edit?id='+curRow.id+"&noparnet=1");
    }
    ...
    function doSee(idx) {
        var curRow = $('#whgdg').datagrid('getRows')[idx];
        WhgComm.editDialog('${basePath}/admin/system/cult/view/edit?id='+curRow.id+"&onlyshow=1&noparnet=1");
    }
