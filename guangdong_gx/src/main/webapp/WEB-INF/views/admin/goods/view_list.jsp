...
<head>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:set var="pageTitle" value="文艺辅材列表"></c:set>
        </c:otherwise>
    </c:choose>
...
<div id="tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-textbox" name="name" prompt="请输入文艺辅材名称" data-options="width:200">
...
<script>
    ...
    $(function(){
        ...
        WhgComm.search('#whgdg', '#tb', '${basePath}/admin/goods/srchList4p?pageType=${pageType}');
    });
    ...
    Gridopts.prototype.resource = function(idx) {
        ...
        WhgComm.editDialog('${basePath}/admin/mass/resmanage/view/list?refid=' + row.id+'&reftype=20');
    };
