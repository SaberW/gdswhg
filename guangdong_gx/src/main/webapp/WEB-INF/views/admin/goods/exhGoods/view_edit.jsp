...
<script>
    //图片初始化
    var __WhgUploadImg = WhgUploadImg.init({basePath: '${basePath}', uploadBtnId: 'imgUploadBtn1', hiddenFieldId: 'cult_picture1', previewImgId: 'previewImg1',needCut:false});
        ...
        frm.form({
            ...
            onSubmit: function (param) {
                ...
                //if(isValid){
                    ...
                    if (isValid && (!etype || etype.size()==0)){
                        $.messager.alert("错误", '展品类型不能为空', 'error');
                        isValid = false;
                    }
                    if (isValid && !cowrydesc.hasContents()){
                        $.messager.alert("错误", '展品简介不能为空', 'error');
                        isValid = false;
                    }
                //}
                if (!isValid){
