...
<head>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:set var="pageTitle" value="展品列表"></c:set>
        </c:otherwise>
    </c:choose>
...
<table id="whgdg" class="easyui-datagrid" title="${pageTitle}" style="display: none;"
    ...
    <thead>
    <tr>
        <th data-options="width:150, sortable:false, field:'title' ">展品名称</th>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-textbox" name="title" prompt="请输入展品名称" data-options="width:200">
...
<div id="whgdg-opt" style="display: none;">
   ...
   &lt;%&ndash; <shiro:hasPermission name="${resourceid}:ziyuan"><a plain="true" method="resource">资源管理</a></shiro:hasPermission>&ndash;%&gt;
...
<script>
    ...
    $(function () {
        ...
        WhgComm.search('#whgdg', '#whgdg-tb', '${basePath}/admin/exhGoods/srchList4p?pageType=${pageType}');
    });
