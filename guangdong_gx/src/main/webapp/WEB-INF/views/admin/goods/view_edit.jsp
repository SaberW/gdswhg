...
<head>
    ...
    <c:choose>
        <c:when test="${pageType eq 'show'}">
            <c:set var="pageTitle" value="文艺辅材管理-查看"></c:set>
        </c:when>
        <c:when test="${pageType eq 'edit'}">
            <c:set var="pageTitle" value="文艺辅材管理-编辑"></c:set>
        </c:when>
        <c:otherwise>
            <c:set var="pageTitle" value="文艺辅材管理-添加"></c:set>
        </c:otherwise>
    </c:choose>
...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="name" value="${info.good.name}" style="width:500px; height:32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input type="hidden" id="cult_picture1" name="imgurl" value="${info.good.imgurl}">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>分类：</div>
        <div class="whgff-row-input">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-numberbox" name="number" value="${info.good.number}" style="width:200px; height:32px"
                   data-options="required:true,min:0,max:1000000, prompt:'请输入数量'">套
        </div>
    </div>
    ...
    <%--<div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="radio radio-primary whg-js-data" name="hasfees" value="${info.good.hasfees}"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="contacts" value="${info.good.contacts}" style="width:500px; height:32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="phone" value="${info.good.phone}" style="width:500px; height:32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="email" value="${info.good.email}" style="width:500px; height:32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="workplace" value="${info.good.workplace}" style="width:300px; height:32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="telephone" value="${info.good.telephone}" style="width:300px; height:32px"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="goodsexplain" value="${not empty info.good.goodsexplain? info.good.goodsexplain :'一旦达成意向，经费参照国家和地方相关标准执行，相关具体事宜由派出方与承接方相互协商而定。'}" style="width:500px; height:60px"
                   data-options="multiline:true,required:true,validType:['length[1,500]'], prompt:'请输入说明'">
        </div>
    </div>

    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>介绍：</div>
        <div class="whgff-row-input">
            <div id="description" name="_description" type="text/plain" style="width:800px; height:200px;"></div>
            <textarea id="value_description" style="display: none;">${info.good.description}</textarea>
        </div>
    </div>
...
<script>
    ...
    $(function(){
        ...
        var state = '${info.good.state}';
        if (state && state == 4) {
            showXjReason('${info.good.id}');
        }
        formTool.init();
    });
    ...
    var formTool = {
        ...
        init: function(){
            ...
            WhgComm.initPMS({
                basePath:'${basePath}',
                cultEid:'cultid', cultValue:'${info.good.cultid}',
                deptEid:'deptid', deptValue:'${info.good.deptid}',
                ywiTypeEid:'etype', ywiTypeValue:'${info.good.etype}', ywiTypeClass:20,
                ywiKeyEid:'ekey', ywiKeyValue:'${info.good.ekey}', ywiKeyClass:20,
                ywiTagEid:'etag', ywiTagValue:'${info.good.etag}', ywiTagClass:20

                ,provinceEid:'province', provinceValue:'${info.good.province}',
                cityEid:'__CITY_ELE', cityValue:'${info.good.city}',
                areaEid:'__AREA_ELE', areaValue:'${info.good.area}'

                /*,psprovinceEid:'__PSPROVINCE_ELE', psprovinceValue:'${info.good.psprovince}',
                pscityEid:'__PSCITY_ELE', pscityValue:'${info.good.pscity}'*/
            });
        },
...
//                                    }
        ...
        __validata: function (param) {
            ...
            var etype = $("[name='etype']:radio:checked");
            if (!etype || etype.size()==0){
                $.messager.alert("错误", '分类不能为空', 'error');
                return false;
            }


            if (!me.ue_description.hasContents()){
                $.messager.alert("错误", '介绍不能为空', 'error');
                return false;
            }else{
