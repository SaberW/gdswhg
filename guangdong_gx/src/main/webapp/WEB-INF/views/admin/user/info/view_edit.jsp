...
<form id="whgff" class="whgff" method="post">
    ...
    <%--<div class="whgff-row">
        <div class="whgff-row-label">授权项目：</div>
        <div class="whgff-row-input">
            <div class="checkbox checkbox-primary whg-js-data" name="productids"
                 value="${productids}"
                 js-data="WhgComm.getFromProject"></div>
        </div>
    </div>--%>
</form>
...
<script type="text/javascript">
    $(function () {
        ...
        if($('#whgff input[name="onlyshow"]').val() == "1"){
            ...
            $("#whgff input[type='radio']").attr('disabled', true);
        }

        $("#whgff input[type='checkbox']").attr('disabled', true);
    });
</script>
<!-- script END -->
</body>
