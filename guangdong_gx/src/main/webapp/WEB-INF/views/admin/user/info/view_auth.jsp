...
<head>
    ...
    <script type="text/javascript">
        ...
        /** 证件类型 */
        function getIdcardtypeData(){
            return [{"id":"1", "text":"中国大陆"},{"id":"2", "text":"港澳台"}]
        }
    </script>
</head>
<body>
...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="radio radio-primary whg-js-data" name="idcardtype" value="${whuser.idcardtype}" js-data="getIdcardtypeData">
            </div>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input type="text" class="easyui-datebox" style="width:300px;height: 32px;" name="birthday" value="<fmt:formatDate value="${whuser.birthday}" pattern="yyyy-MM-dd"/>" data-options="prompt:'请选择'"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <div class="whgff-row-input-imgview" style="background: url(${basePath}/static/admin/img/no-img.png) no-repeat 50% 50%; width: 450px;">
                <c:if test="${not empty whuser.idcardface}">
                    <img src="${baseImgPath}${whuser.idcardface}" style="width: 450px; height: 225px;" alt="身份证正面">
                </c:if>
            </div>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <div class="whgff-row-input-imgview" style="background: url(${basePath}/static/admin/img/no-img.png) no-repeat 50% 50%; width: 450px;">
                <c:if test="${not empty whuser.idcardback}">
                    <img src="${baseImgPath}${whuser.idcardback}" style="width: 450px; height: 225px;" alt="身份证背面">
                </c:if>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    $(function () {
        ...
        if($('#whgff input[name="onlyshow"]').val() == "1"){
            ...
            $("#whgff :radio[name='sex']").attr('disabled', true);
            $("#whgff :radio[name='idcardtype']").attr('disabled', true);
            $('#whgff .easyui-datebox').combobox('readonly');
        }
    });
</script>
<!-- script END -->
