...
<head>
    ...
    <c:choose>
        <c:when test="${not empty id and not empty targetShow}">
            <c:set var="pageTitle" value="线下培训-查看"></c:set>
        </c:when>
        <c:when test="${not empty id}">
            <c:set var="pageTitle" value="线下培训-编辑"></c:set>
        </c:when>
    </c:choose>
...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label">所在场馆：</div>
        <div class="whgff-row-input">
            <input class="easyui-combobox" style="width:245px; height:32px" name="venue" id="venue" data-options="required:false" />
            <input class="easyui-combobox" style="width:245px; height:32px" name="venroom" id="venroom" data-options="required:false" />
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-combobox" id="groupid" name="groupid" value="${whgTra.groupid}" style="width:500px; height:32px"
                   data-options="limitToList:true, valueField:'id', textField:'name'"/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-numberbox" id="longitude" name="longitude" value="${whgTra.longitude}" style="width:100px; height:32px" data-options="required:true,precision:6,readonly:true,prompt:'X轴'">
            <input class="easyui-numberbox" id="latitude" name="latitude" value="${whgTra.latitude}" style="width:100px; height:32px" data-options="required:true,precision:6,readonly:true,prompt:'y轴'">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="checkbox checkbox-primary whg-js-data" value="${whgTra.noticetype}" name="noticetype" id="noticetype"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="duration" value="${whgTra.duration}" style="width:500px; height:32px" data-options="validType:['length[1,100]'],prompt:'请填写培训时长。如：180分钟，3个月，15天。'">
        </div>
    </div>
...
<script>
        ...
        if(id){
            ...
            if(0 == isMulti){
                ...
                if(state == 4){
                    ...
                    $('input[name="ismultisite"]:not(:checked)').attr('disabled', true);
    ...
    $(function () {
        WhgComm.initPMS({
            ...
            ywiTypeEid:'etype', ywiTypeValue:'${whgTra.etype}', ywiTypeClass:5,
            ywiKeyEid:'ekey', ywiKeyValue:'${whgTra.ekey}', ywiKeyClass:5,
            ywiTagEid:'etag', ywiTagValue:'${whgTra.etag}', ywiTagClass:5,
        ...
        if (targetShow){
            ...
            window.setTimeout(function(){$('.easyui-combobox').combobox('readonly'); },1500);
