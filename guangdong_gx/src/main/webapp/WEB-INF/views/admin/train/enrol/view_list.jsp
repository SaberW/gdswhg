...
<div id="whgdg-opt" style="display: none;">
    <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" <%--validKey="state" validVal="1"--%> validFun="validZc4Checkon" method="checkon">审核</a>
...
<script>
    ...
    $(function () {
        ...
        var vzc = validZc4Checkon();
        if (!vzc){
            $(".checkon").linkbutton('disable');
