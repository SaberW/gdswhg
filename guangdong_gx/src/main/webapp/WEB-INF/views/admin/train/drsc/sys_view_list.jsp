...
<div data-options="region:'center',title:'培训资源'">
    <!-- 表格 -->
    ...
    <div id="whgdg-tb" style="display: none;">
        <div class="whgdg-tb-srch">
            ...
            <input class="easyui-textbox" style="width: 200px;" name="drsctitle" data-options="prompt:'请输入培训资源名称', validType:'length[1,32]'" />
            ...
            <input class="easyui-combobox" name="drscstate" id="state" prompt="请选择状态" data-options="editable:false,width:110, panelHeight:'auto', limitToList:true"/>
    ...
    <div id="whgdg-opt" style="display: none;">
        ...
        <shiro:hasPermission name="${resourceid}:publishoff"><a href="javascript:void(0)" class="easyui-linkbutton" validKey="drscstate" validVal="6" plain="true" method="whgListTool.sysPublishoff">撤销发布</a></shiro:hasPermission>
...
<script>
    ...
    $(function () {
        ...
        WhgCommAreaTree.initAreaTree({
            ...
            onSelect: function(node){
                ...
                WhgComm.search('#whgdg', '#whgdg-tb', '${basePath}/admin/drsc/srchSysList4p');
            }
        });
    });

    var whgListTool = new Gridopts({pageType: "${type}", pageTypeS:'syspublish', modeUrlTag:'/index', rowIdKey:'drscid'});
    ...
    /*function __updStateSend(ids, formstates, tostate){
        ...
        $.post('${basePath}/admin/drsc/updState', params, function(data){
