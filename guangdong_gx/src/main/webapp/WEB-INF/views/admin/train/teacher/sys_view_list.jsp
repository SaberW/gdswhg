...
<div data-options="region:'center',title:'培训师资'">
    <!-- 表格 -->
    ...
    <div id="whgdg-tb" style="display: none;">
        <div class="whgdg-tb-srch">
            ...
            <input class="easyui-textbox" style="width: 200px;" name="name" data-options="prompt:'请输入培训师资名称', validType:'length[1,32]'" />
    ...
    $(function () {
        ...
        WhgCommAreaTree.initAreaTree({
            ...
            onSelect: function(node){
                ...
                WhgComm.search('#whgdg', '#whgdg-tb', '${basePath}/admin/train/tea/srchSysList4p');
            }
        });
    });
