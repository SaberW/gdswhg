...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input" >
            <input class="easyui-textbox" id="tratitle" value="${leave.tratitle}" style="width:425px; height:35px" readonly/>
        </div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label" ><label style="color: red">*</label>上课时间：</div>
        <div class="whgff-row-input" >
            <input class="easyui-datetimebox" id="starttime" value="<fmt:formatDate value="${ leave.starttime}" pattern="yyyy-MM-dd HH:mm:ss"/>" style="width:200px; height:32px" readonly/>至
            <input class="easyui-datetimebox" id="endtime" value="<fmt:formatDate value='${leave.endtime}' pattern='yyyy-MM-dd HH:mm:ss'/>" style="width:200px; height:32px" readonly/>
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input" >
            <input class="easyui-textbox" id="proposer" value="${leave.proposer}" style="width:425px; height:35px" readonly/>
        </div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label" ><label style="color: red">*</label>请假原因：</div>
        <div class="whgff-row-input" >
            <input class="easyui-textbox" id="cause" value="${leave.cause}" style="width:425px; height:80px" data-options="multiline:true" readonly/>
        </div>
    </div>
    <div class="whgff-row">
