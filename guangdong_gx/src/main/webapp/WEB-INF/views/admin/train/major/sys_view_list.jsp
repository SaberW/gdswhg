...
<div data-options="region:'center',title:'微专业'">
    <!-- 表格 -->
    ...
    <div id="whgdg-tb" style="display: none;">
        <div class="whgdg-tb-srch">
            ...
            <input class="easyui-textbox" style="width: 200px;" name="name" data-options="prompt:'请输入微专业名称', validType:'length[1,32]'" />
...
<script>
    ...
    $(function () {
        ...
        WhgCommAreaTree.initAreaTree({
            ...
            onSelect: function(node){
                ...
                WhgComm.search('#whgdg', '#whgdg-tb', '${basePath}/admin/tra/major/srchSysList4p');
            }
        });
    });
    ...
    /*function __updStateSend(ids, formstates, tostate){
        ...
        $.post('${basePath}/admin/tra/major/updstate', params, function(data){
