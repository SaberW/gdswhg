...
<head>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:set var="pageTitle" value="线下培训-添加"></c:set>
        </c:otherwise>
    </c:choose>
...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-combobox" id="teachername" name="teachername" value="${whgTra.teachername}" style="width:500px; height:32px" data-options="multiple:true,editable:true"/>
            <span>（如需手动输入，请用英文逗号隔开！）</span>
        </div>
    </div>
   ...
   <div class="whgff-row">
    ...
    <%--<div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="radio radio-primary whg-js-data" name="noticetype" id="noticetype"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div id="detail" name="detail" type="text/plain" style="width:600px; height:300px;"></div>
        </div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red"></label>培训大纲：</div>
        <div class="whgff-row-input">
            <div id="catalog" name="catalog" type="text/plain" style="width:600px; height:300px;"></div>
        </div>
    </div>
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red"></label>老师介绍：</div>
        <div class="whgff-row-input">
            <div id="teacherIntro" name="teacherIntro" type="text/plain" style="width:600px; height:300px;"></div>
        </div>
    </div>
...
<script>
    ...
    $(function () {
        WhgComm.initPMS({
            ...
            venEid:'venue', venValue:false,
            roomEid:'venroom', roomValue:false
        });
