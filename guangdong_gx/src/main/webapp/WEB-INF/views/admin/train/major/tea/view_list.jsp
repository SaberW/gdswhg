...
<table id="whgdg" title="师资管理" class="easyui-datagrid" style="display: none"
    ...
    <thead>
    <tr>
        <th data-options="field:'tname', width:100">老师名称</th>
...
<div id="whgdg-opt2" style="display: none;">
    <a href="javascript:void(0)" style="color: #0e0e0e; font-weight: bold" class="easyui-linkbutton" plain="true" method="_add">添加</a>
</div>
<!-- 操作按钮-END -->
