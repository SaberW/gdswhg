...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>名　　称：</div>
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>类　　型：</div>
        <div class="whgff-row-input">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>微专业简介：</div>
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="detail" id="detail" value="${major.detail}" style="width:600px; height:128px" data-options="multiline:true, required:true, validType:['length[1,2000]'], prompt:'请填写微专业简介'">
   ...
   // detail.ready(function(){  detail.setContent($("#value_detail").val())});
    ...
    function myChangeCity(newVal, oldVal) {
        changeCity(newVal, oldVal, function(){
            if(typeof(window.__init_area) == 'undefined'){
                $('#__AREA_ELE').combobox('setValue', '${major.area}');
    ...
    $(function () {
        WhgComm.initPMS({
            ...
            deptEid:'deptid', deptValue:'${major.deptid}',
        });
            ...
            onSubmit: function (param) {
                ...
                if(isValid){
                    ...
                    /*if (!detail.hasContents()){
                        $.messager.alert("错误", '微专业详情不能为空！', 'error');
                        isValid = false;
                    }*/
                }
                if (!isValid){
