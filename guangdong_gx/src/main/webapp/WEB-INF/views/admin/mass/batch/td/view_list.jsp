...
<div id="pagelayout" class="easyui-layout" data-options="fit:true">
    ...
    <div data-options="region:'center',title:'届次艺术团队列表'">
...
--%>
    ...
    <div data-options="region:'east', title:'艺术团队列表',split:true, width:'40%'">
...
<script>
    ...
    var paramLoader = function (param, success, error) {
        ...
        param.mtype = '${mtype}';
        $.ajax({
            url: '${basePath}/admin/mass/ref/getreftdlist',
            type: 'post',
            data : param,
            dataType: 'json',
            success: success,
    ...
    var paramLoader2 = function (param, success, error) {
        ...
        param.mtype = '${mtype}';
        $.ajax({
            url: '${basePath}/admin/mass/ref/gettdlist',
            type: 'post',
            data : param,
            dataType: 'json',
            success: success,
    ...
    Gridopts.prototype.addRef = function(){
        ...
        this.__ajaxTempSend("/addRefTd", {ids:ids, mid:'${mid}', mtype:'${mtype}' });
    };
    Gridopts.prototype.removeRef = function(){
        ...
        this.__ajaxTempSend("/removeRefTd", {ids:ids, mid:'${mid}', mtype:'${mtype}' });
    };
    ...
    Gridopts.prototype.show = function(idx){
        ...
        var nowsrc = '${basePath}/admin/mass/team/view/show?id='+row.id;
