...
<head>
    ...
    <script type="text/javascript" src="${basePath}/static/admin/js/customfield.js"></script>
</head>
<body style="overflow-x: hidden">

<div class="container-fluid">
    <form class="form-horizontal" role="form" id="whgff" style="margin-top: 20px;" method="post">
        <input type="hidden" id="id" name="id" value="${whgMassType.id}" />

        <div class="form-group">
            <label class="col-sm-2 control-label" for="name"><i style="color:red;">*</i>名称：</label>
            <div class="col-sm-10">
                <input class="easyui-textbox" style="width: 90%; height: 34px;" id="name" name="name" value="${whgMassType.name}" data-options="prompt:'请输入资源分类名称',required:true, validType:['length[0,32]']" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="easyui-numberspinner" style="width: 90%; height: 34px;" id="idx" name="idx" value="${whgMassType.idx}" data-options="prompt:'请输入资源分类的排序',required:true, min:1, max:999" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea id="textarea_memo" style="display: none;">${whgMassType.memo}</textarea>
...
<script type="text/javascript">
    ...
    function initForm(){
        ...
        $('#whgff').form({
            novalidate: true,
            url: "${basePath}/admin/mass/type/edit",
