...
<div data-options="region:'center',title:'群文资源'">
        ...
        <table id="whgdg" class="easyui-datagrid" style="display: none"
            ...
            <tr>
                ...
                <th data-options="field:'name', width:150">所属资源库</th>
        ...
        <div id="whgdg-opt" style="display: none;">
            ...
            <shiro:hasPermission name="${resourceid}:checkon"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="validCheckon" method="doCheckon">审核通过</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:checkoff"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="validCheckoff" method="doCheckoff">审核打回</a></shiro:hasPermission>
            ...
            <shiro:hasPermission name="${resourceid}:recommend"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="validRecommend" method="doRecommend">推荐</a></shiro:hasPermission>
            <shiro:hasPermission name="${resourceid}:recommendoff"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="validRecommendoff" method="doRecommendoff">撤销推荐</a></shiro:hasPermission>
        ...
        var optDialog =$('<div></div>').dialog({
            ...
            buttons: [{
                ...
                handler:function(){
                    ...
                    var params = {libid: curRow.libid, id:curRow.id, state: 4, reason: reason, issms: issms};

                    $.messager.progress();
                    $.ajax({
                        url: '${basePath}/admin/mass/libres/updateState',
                        data: params,
                        type: 'post',
                        dataType: 'json',
