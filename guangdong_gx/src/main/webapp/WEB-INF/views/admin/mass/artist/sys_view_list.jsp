...
<div data-options="region:'center',title:'艺术人才列表'" >
    ...
    <table id="whgdg" class="easyui-datagrid" style="display: none;"
        ...
        <thead>
        <tr>
            <th data-options="sortable:false,width:150, field:'name' ">姓名</th>
            <th data-options="sortable:false, field:'cultname' ">所属文化馆</th>
            <th data-options="sortable:false,width:200, field:'company' ">工作单位</th>
            <th data-options="sortable:false,width:150, field:'job' ">职务</th>
            <th data-options="sortable:false,width:150, field:'feattype' ">专长类型</th>
    ...
    <div id="tb" style="display: none;">
        ...
        <div class="whgdg-tb-srch">
            <input class="easyui-textbox" name="name" prompt="请输入姓名" data-options="width:200">
    ...
    $(function(){
        ...
        WhgCommAreaTree.initAreaTree({
            ...
            onSelect: function(node){
                ...
                WhgComm.search('#whgdg', '#tb', '${basePath}/admin/mass/artist/sysSrchList4p');
            }
        })
