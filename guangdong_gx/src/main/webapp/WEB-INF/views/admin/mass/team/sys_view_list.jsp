...
<div data-options="region:'center',title:'艺术团队列表'" >
    ...
    <div id="tb" style="display: none;">
        ...
        <div class="whgdg-tb-srch">
            <input class="easyui-textbox" name="name" prompt="请输入名称" data-options="width:200">
    ...
    $(function(){
        ...
        WhgCommAreaTree.initAreaTree({
            ...
            onSelect: function(node){
                ...
                WhgComm.search('#whgdg', '#tb', '${basePath}/admin/mass/team/sysSrchList4p');
            }
        })
