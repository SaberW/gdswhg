...
<head>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:set var="pageTitle" value="群文资源列表"></c:set>
        </c:otherwise>
    </c:choose>
...
<table id="whgdg" class="easyui-datagrid" title="${pageTitle}" style="display: none;"
    ...
    <tr>
        ...
        <th data-options="sortable:false, field:'company' ">艺术类型</th>
        <th data-options="sortable:false, field:'job' ">作者</th>
...
<div id="tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-textbox" name="title" prompt="请输入资源名称" data-options="width:120">
...
<div id="whgdg-opt" style="display: none;">
    ...
    <shiro:hasPermission name="${resourceid}:checkoff"><a plain="true" method="whgListTool.back" validKey="state"
                                                          validVal="9,2">打回</a></shiro:hasPermission>
    <%--
        <shiro:hasPermission name="${resourceid}:edit">
...
<script>
    ...
    Gridopts.prototype.paramLoader = function (param, success, error) {
        ...
        $.ajax({
            url: '${basePath}/admin/mass/resource/srchList4p?pageType=${pageType}',
            type: 'post',
            data : param,
            dataType: 'json',
            success: success,
