...
<div class="container-fluid">
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            <li><i class="icon-home"></i><a>培训指数 &gt; 在线课程</a></li>
        </ul>
    </div>
    ...
    <div class="res-cont-row-1">
        <ul>
            ...
            <li><div class="cont active"><h2>在线课程量</h2><p>${allTrainIndex.ZB}</p></div></li>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <table id="whgdg" class="easyui-datagrid" style="display: none; width:100%; height: 300px;"
                                   data-options="striped:true, rownumbers:true, fitColumns:true, singleSelect:true, pagination:true, toolbar:'#whgdg-tb', sort:'totalvisit', order:'desc', queryParams:{cultid:'${cultid}', islive:1}, url:'${basePath}/admin/traindex/srchList4p4visit'">
                                <thead>
                                <tr>
                    ...
                    <div class="row-fluid">
                        <div class="span12">
                            ...
                            <table id="whgdg2" class="easyui-datagrid" style="display: none; width:100%; height: 300px;"
                                   data-options="striped:true, rownumbers:true, fitColumns:true, singleSelect:true, pagination:true, toolbar:'#whgdg-tb2', sort:'totalbm', order:'desc', queryParams:{cultid:'${cultid}', islive:1}, url:'${basePath}/admin/traindex/srchList4p4bm'">
                                <thead>
                                <tr>
                                    <th data-options="field:'title', width:100">培训标题</th>
...
<script type="text/javascript">
    ...
    $('#cultid').change(function () {
        ...
        window.location.href = '${basePath}/admin/traindex/view/zb?cultid='+cultid;
    });
    $("#cultid ").val("${cultid}");
    ...
    $(window).resize(function() {
        if(plot1.replot)plot1.replot({resetAxes:true});
        if(plot2.replot)plot2.replot({resetAxes:true});
        if(plot3.replot)plot3.replot({resetAxes:true});
    });
