...
<div class="container-fluid">
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            <li><i class="icon-home"></i><a>培训指数 &gt; 微专业</a></li>
        </ul>
    </div>
    ...
    <div class="res-cont-row-1">
        <ul>
            ...
            <li><div class="cont active"><h2>微专业数量</h2><p>${allTrainIndex.WZ}</p></div></li>
...
<script type="text/javascript">
    ...
    $('#cultid').change(function () {
        ...
        window.location.href = '${basePath}/admin/traindex/view/wz?cultid='+cultid;
    });
    $("#cultid ").val("${cultid}");
