...
<div class="container-fluid">
    <div class="crumbs">
        <ul id="breadcrumbs" class="breadcrumb">
            <li><i class="icon-home"></i><a>培训指数 &gt; 培训师资</a></li>
        </ul>
    </div>
    ...
    <div class="res-cont-row-1">
        <ul>
            ...
            <li><div class="cont active"><h2>培训师资量</h2><p>${allTrainIndex.SZ}</p></div></li>
...
<script type="text/javascript">
    ...
    $('#cultid').change(function () {
        ...
        window.location.href = '${basePath}/admin/traindex/view/sz?cultid='+cultid;
    });
    $("#cultid ").val("${cultid}");
