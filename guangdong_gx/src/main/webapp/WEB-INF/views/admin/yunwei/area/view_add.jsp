...
<div class="container-fluid">
    <form class="form-horizontal" role="form" id="whgff" style="margin-top: 20px;" method="post">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="easyui-textbox" style="width: 90%; height: 34px;" id="name" name="name" data-options="prompt:'请输入地址名称',required:true, validType:['length[0,32]']" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="easyui-textbox" style="width: 90%; height: 34px;" id="code" name="code" data-options="prompt:'请输入地址编码，可站点访问前缀，小写字母及数字组合',required:true, validType:['length[3,10]', 'xyz']" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="easyui-numberspinner" style="width: 90%; height: 34px;" id="idx" name="idx" value="1" data-options="prompt:'请输入地址的排序',required:true, min:1, max:999" />
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input class="easyui-textbox" style="width: 90%; height: 100px;" id="memo" name="memo" data-options="prompt:'请输入地址备注信息', multiline:true, validType:['length[0,250]']" />
            </div>
        </div>
...
<script type="text/javascript">
    ...
    function initForm(){
        ...
        $('#whgff').form({
            novalidate: true,
            url: "${basePath}/admin/yunwei/area/add",
