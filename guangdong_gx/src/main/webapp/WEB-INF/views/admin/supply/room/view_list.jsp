...
<head>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:set var="pageTitle" value="供需活动室列表"></c:set>
        </c:otherwise>
    </c:choose>
...
<body>
    ...
    <table id="whgdg" class="easyui-datagrid" title="${pageTitle}" style="display: none;"
        ...
        <thead>
            <tr>
                ...
                <th data-options="sortable: true, field:'etype' ">类型</th>
    ...
    <div id="whgdg-opt" style="display: none;">
        ...
        <%--<shiro:hasPermission name="${resourceid}:reserve">
            <a plain="true" method="whgListTool.reserve" validKey="state" validVal="6">订单管理</a>
        </shiro:hasPermission>--%>
    ...
    $(function(){
        WhgComm.initPMS({
            ...
            cultOnChange: function(val, oval){
                $('#venid').combobox({
                    limitToList:true, novalidate:true, valueField:'id', textField:'title',
        ...
        WhgComm.search('#whgdg', '#tb', '${basePath}/admin/supply/room/srchList4p?pageType=${pageType}');
    });
