...
<head>
    ...
    <c:choose>
        ...
        <c:otherwise>
            <c:set var="pageTitle" value="供需场馆列表"></c:set>
        </c:otherwise>
    </c:choose>
    ...
    <table id="whgdg" class="easyui-datagrid" title="${pageTitle}" style="display: none;"
        ...
        <thead>
            <tr>
                ...
                <th data-options="sortable:false, field:'area' ">区域</th>
                <th data-options="sortable:false, field:'address' ">地址</th>
                <th data-options="sortable: true, field:'etype',formatter:WhgComm.FMTVenueType ">分类</th>
...
<script>
    ...
    $(function(){
        ...
        WhgComm.search('#whgdg', '#tb', '${basePath}/admin/supply/ven/srchList4p?pageType=${pageType}');
    });
