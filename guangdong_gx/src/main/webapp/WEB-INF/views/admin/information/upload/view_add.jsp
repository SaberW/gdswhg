...
<form id="whgff" method="post" class="whgff" enctype="multipart/form-data">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="upname" style="width:600px; height:32px"
        ...
        <div class="whgff-row-input">
            ...
            <div class="whgff-row-input" id="filepath">
                <i><a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-save"
                      id="fileUploadBtn1">选择文件</a></i>
                <i>附件格式为doc,docx,xls,zip,xlsx,pdf建议文件大小为10MB以内</i>
            </div>
        </div>
    </div>
...
<script>
    $(function () {
        ...
        var whgFile = WhgUploadFile.init({
            basePath: '${basePath}',
            uploadBtnId: 'fileUploadBtn1',
            hiddenFieldId: 'act_filepath1'
        });
        $('#whgff').form({
            novalidate: true,
            url: '${basePath}/admin/infoupload/adduploda',
            onSubmit: function (param) {
                param.uptype = '${refid}';
                param.upstate = 0;
                var _valid = $(this).form('enableValidation').form('validate');
                var patchPath = $("#act_filepath1").val();
                if (_valid == true && patchPath == "") {
                    $.messager.alert('提示', '请选择上传资料');
                    _valid = false;
                }
                if (!_valid) {
