...
function showProject(val, rowData, index) {
    ...
    if (rowData.toproject && rowData.toproject.indexOf("QWZY") != -1) {
        str += " 群文资源";
    }
    if(str!=""){
		...
		<form method="post" id="whgff" enctype="multipart/form-data" class="whgff">
		 <!-- 隐藏作用域 -->
			<div class="main">
				...
				<div class="row">
					<div><label>关联前端菜单:</label></div>
					<div class="whgff-row-input" data-check="true" target="frontmenu" err-msg="请至少选择一个菜单">
						<input class="easyui-combobox" style="width: 200px;" name="frontmenu" panelHeight="auto"
							   limitToList="true"
							   data-options="prompt:'请选择菜单', valueField:'id', textField:'text', data:WhgComm.getFrontMenu()"/>
					</div>
				</div>
				<%--<div class="row">
