...
<form id="whgff" method="post" class="whgff" enctype="multipart/form-data">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="upname" value="${upload.upname}"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input id="act_filepath1" name="uplink" data-options="required:true" value="${upload.uplink}"
                   style="width:600px;height:32px;"
                   readonly="readonly">
...
<script>
    $(function () {
        ...
        $('#whgff').form({
            novalidate: true,
            url: '${basePath}/admin/infoupload/douploda?upid=' +${upid},
            onSubmit: function () {
