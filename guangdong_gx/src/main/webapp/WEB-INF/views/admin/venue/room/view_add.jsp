...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><i>*</i>是否需实名：</div>
        <div class="whgff-row-input">
            <div class="radio radio-primary whg-js-data" name="isrealname" value="${info.isrealname}"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="checkbox checkbox-primary whg-js-data" name="noticetype" value="${info.noticetype}"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="telephone" value="${info.telephone}" style="width:300px; height:32px"
                   data-options="required:true,validType:['length[1,20]', 'isTel'], prompt:'请输入固定电话号码'">
        </div>
    </div>
    ...
    var formTool = {
        ...
        init: function () {
            ...
            WhgComm.initPMS({
                ...
                venEid:'venid', venValue:'${info.venid}',moreVen:false,
        ...
        __validata: function (param) {
            ...
            if (!etype || !etype.length){
                $.messager.alert("错误", '活动室分类不能为空', 'error');
                return false;
            }

            var noticetype = $("[name='noticetype']:checkbox:checked");
