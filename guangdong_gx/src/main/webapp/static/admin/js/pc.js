...
function getVisitSumCount4url(urlfag, callback){
    var tongji_pv = document.getElementById("whgtongji");
    var t_src = tongji_pv.src;
    console.log(t_src);
    $.getJSON(getBasePath(t_src)+"/visit/getcount4url", {urlfag: urlfag}, function (data) {
...
function getBasePath(tsrc) {
    ...
    if(tsrc && tsrc.length > 0){
        ...
        */
        var __idx = tsrc.indexOf("/static");
        __basePath = tsrc.substring(0, __idx);
        //console.log('path:'+__basePath);
    }
