...
WhgUploadFile = (function () {
    ...
    function __obj_Construct(options){
        ...
        if ($('#'+thisObj._options.hiddenFieldId).val()) {
            ...
            for (var i in filePaths) {
                ...
                html += '<div class="singleFile"><a href="#">'+fileName+'</a><span class="cancelFileBtn" fileurl = "'+filePaths[i]+'" ></span></div>';
            }
        ...
        this._uploader = new plupload.Uploader({
            ...
            filters: {
                mime_types: [
                    ...
                    {title: "Doc files", extensions: "doc,docx,xls,xlsx,pdf,mp4"}
                ],
    ...
    __obj_Construct.prototype._addFile = function (up, files) {
        for(var i=0; i<files.length; i++){
            ...
            if(indexOf!=-1){
                console.log("iiiiii")
                filename= filename.substr(0,indexOf);
            }
            $("#whg_file_upload_name").attr("value",filename);
            console.log("oooo")
