...
public class WhgSystemDeptController extends BaseController{
     ...
     * @return 对象列表
     */
    @RequestMapping(value = "/srchList4tree")
    @ResponseBody
    public List<Map<String, String>> srchList(String cultid, String id){
        List<Map<String, String>> list = new ArrayList<>();
        try {
            List<WhgSysDept> deptList = service.t_srchList4tree(cultid, id);
            if(deptList != null){
