...
public class WhgYunweiSysTempController extends BaseController{
    /**
     * log
     */
    ...
    public ResponseBean srchList4p(HttpServletRequest request, WhgYwiSmstmp whgYwiSmstmp) {
        ...
        try {
            PageInfo<WhgYwiSmstmp> pageInfo = whgYunweiSmsTmpService.t_srchList4p(page,rows,whgYwiSmstmp);
    ...
    public ResponseBean edit(HttpServletRequest request, WhgYwiSmstmp whgYwiSmstmp) {
        ...
        try {
            String id = request.getParameter("id");
            this.whgYunweiSmsTmpService.t_edit(id, whgYwiSmstmp);
        } catch (Exception e) {
            res.setSuccess(ResponseBean.FAIL);
            res.setErrormsg(e.getMessage());
            log.error(e.getMessage(), e);
    ...
    public ResponseBean del(HttpServletRequest request) {
        ...
        try {
            String id = request.getParameter("id");
            this.whgYunweiSmsTmpService.t_del(id);
        } catch (Exception e) {
            res.setSuccess(ResponseBean.FAIL);
            res.setErrormsg(e.getMessage());
