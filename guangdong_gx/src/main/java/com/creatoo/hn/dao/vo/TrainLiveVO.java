...
public class TrainLiveVO extends WhgTra implements Serializable {
     ...
     * 培训组限制不能报名
     */
    private Boolean limitEnrolForTrainGroup;
    ...
    public Boolean getLimitEnrolForTrainGroup() {
        return limitEnrolForTrainGroup;
    }

    public void setLimitEnrolForTrainGroup(Boolean limitEnrolForTrainGroup) {
        this.limitEnrolForTrainGroup = limitEnrolForTrainGroup;
    }
