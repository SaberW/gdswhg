 ...
 */
@Service
public class WhgTeaInMajorService extends BaseService{
    @Autowired
    ...
    public PageInfo t_srchlist4p(int page, int rows, String mid) {
        ...
        List<Map> list = this.whgMajorContactMapper.selTeaInMajor(mid);
    ...
    public void t_add(String entid,String mid) {
        ...
        c.andEqualTo("entid",entid).andEqualTo("type",2).andEqualTo("majorid",mid);
