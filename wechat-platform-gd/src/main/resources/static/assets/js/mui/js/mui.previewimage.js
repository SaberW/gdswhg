(function($, window) {
    ...
    var itemTemplate = '<div class="mui-slider-item mui-zoom-wrapper {{className}}"><div class="mui-zoom-scroller"><div class="preview-title">{{title}}</div>' +
    ...
    proto.addImage = function(img) {
        ...
        var title = img.getAttribute('data-preview-title') || '';
        var msg = img.getAttribute('data-preview-msg') || '';
