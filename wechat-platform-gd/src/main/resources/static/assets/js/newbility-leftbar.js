/**
 * Created by zr_boxer on 2017/11/2.
 */
...
!function (n) {
    ...
    if (!n[s]) {
        n[s] = function (e, n, t) {
            ...
            init: function (e) {
                ...
                if (t.hasClass(a.vertical)) {
                    ...
                    var i = n(this.$menu).children("." + a.panel), l = i.filter("." + a.current);
                ...
                var n = this, t = Array.prototype.slice.call(arguments), s = t.shift();
                ...
                i.each(function () {
                    var e = n(this), t = e.parent(), s = t.children("a, span").first();
                    ...
                    if (!e.children("." + a.navbar).length && !t.hasClass(a.vertical)) {
                        if (t.parent().is("." + a.listview))var t = t.closest("." + a.panel); else var s = t.closest("." + a.panel).find('a[href="#' + e.attr("id") + '"]').first(),
                            t = s.closest("." + a.panel);
                        if (t.length) {
                            var i = t.attr("id");
                ...
                d.$body.on(r.click + "-oncanvas", "a[href]", function (t) {
                    var i = n(this), l = !1, r = e.$menu.find(i).length;
        ...
        }, n[s].support = {touch: "ontouchstart" in window || navigator.msMaxTouchPoints};
        var a, l, r, d
    }
}(jQuery);
/*
