...
public class UserCenterAction {
    ...
    @RequestMapping(value = "/myusersecuritypw")
    public ModelAndView toUserSecurityPw(HttpServletRequest request,HttpSession session){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/usercenter/securityPw");
        SeoUtil.setCommcontent(modelAndView,"密码修改",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/mychecktable")
    public ModelAndView toUsserCheckTable(HttpServletRequest request,HttpSession session){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/usercenter/checkTable");
        SeoUtil.setCommcontent(modelAndView,"我的考勤表",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/mychecktable/detail")
    public ModelAndView toUsserCheckTableDetail(HttpServletRequest request,HttpSession session){
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/usercenter/checkTableDetail");
        SeoUtil.setCommcontent(modelAndView,"我的考勤表详情",null,null);
        return modelAndView;
    }
}
