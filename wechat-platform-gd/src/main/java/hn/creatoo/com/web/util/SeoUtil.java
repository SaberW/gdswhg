...
/**
 * Created by zr_boxer on 2017/10/31.
 */
public class SeoUtil {
    public static void setCommcontent(ModelAndView mv, String title, String desc, String key){
        String pageTitle = "文化在线-广东公共数字文化联盟";
        String addTitle =  title != null ? title : pageTitle;
