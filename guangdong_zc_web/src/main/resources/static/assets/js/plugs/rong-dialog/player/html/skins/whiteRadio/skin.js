    ...
    SewisePlayerSkin.Utils = {
        stringer: {
            time2FigFill: function (a) {
                ...
                var b;
                b = a ? a : new Date;
                var a = b.getFullYear(), c = b.getMonth() + 1, j = b.getDate(), d = this.time2FigFill(b.getHours()),
                    f = this.time2FigFill(b.getMinutes());
                b = this.time2FigFill(b.getSeconds());
                return a + "-" + c + "-" + j + " " + d + ":" + f + ":" + b
            }, dateToTimeStr14: function (a) {
                var b = a.getFullYear(), c = this.time2FigFill(a.getMonth() + 1), j = this.time2FigFill(a.getDate()), d = this.time2FigFill(a.getHours()), f = this.time2FigFill(a.getMinutes()), a = this.time2FigFill(a.getSeconds());
                return b + c + j + d + f + a
...
(function (a) {
    SewisePlayerSkin.BannersAds = function (b, c) {
        function j() {
            ...
            m = c[F] || c["0000-00-00"];
            n = 0;
            if (void 0 != m) A = m.length
        }

        function d() {
            for (var a = (new Date).getTime(), b = 0; b < A; b++) {
                var c = SewisePlayerSkin.Utils.stringer.hmsToDate(m[b].time).getTime();
                if (b < A - 1) {
                    var u = SewisePlayerSkin.Utils.stringer.hmsToDate(m[b + 1].time).getTime();
                    if (a > c && a < u) {
                        n = b;
                        i(n);
                        break
        ...
        function f() {
            ...
            if (n < A - 1) {
                var b = SewisePlayerSkin.Utils.stringer.hmsToDate(m[n +
                1].time).getTime();
                a > b && (n++, i(n))
            } else SewisePlayerSkin.Utils.stringer.dateToYMD(new Date) != F && (j(), d())
        }

        function i(a) {
            q = m[a].ads[0].picurl;
            g = m[a].ads[1].picurl;
            "" == q && "" == g || ("" == q && "" != g ? q = g : "" != q && "" == g && (g = q), B.attr("src", q), u.attr("src", g))
        }

        var h = a(' <div style="position:absolute; display:table; width:100%; height:100%;"><div style="display:table-cell; text-align:left; vertical-align:middle;"><img style="pointer-events:auto; cursor:pointer; width: auto; height: auto;"></div></div> ');
        h.appendTo(b);
        var B = h.find("img"), h = a(' <div style="position:absolute; display:table; width:100%; height:100%;"><div style="display:table-cell; text-align:right; vertical-align:middle;"><img style="pointer-events:auto; cursor:pointer; width: auto; height: auto;"></div></div> ');
        h.appendTo(b);
        var u = h.find("img"), q, g, F, m, n, A;
        j();
        void 0 != m && (1 == A && "" == m[0].time ? i(0) : (d(), setInterval(f, 1E4)), B.click(function (a) {
            a.originalEvent.stopPropagation();
            a = m[n].ads[0].link_url;
            window.openAdsLink && "function" == typeof window.openAdsLink ?
                window.openAdsLink(a) : window.open(a, "_blank")
        }), u.click(function (a) {
            a.originalEvent.stopPropagation();
            a = m[n].ads[1].link_url;
...
(function (a) {
    SewisePlayerSkin.AdsContainer = function (b, c) {
        var j = b.$container, d = b.$sewisePlayerUi, f = c.banners;
        if (f) {
            var i = a("<div class='sewise-player-ads-banner'></div>");
            i.css({
                position: "absolute",
                width: "100%",
                height: "100%",
            ...
            i.appendTo(j);
            d.css("z-index", 1);
            SewisePlayerSkin.BannersAds(i, f)
        }
    }
})(window.jQuery);
(function (a) {
...
(function (a) {
    SewisePlayerSkin.ElementLayout = function (b) {
        var c = b.$container, j = b.$controlBarProgress, d = b.$playtime, f = b.defStageWidth, i = b.defLeftValue, h = b.defTopValue, B = b.defOffsetX, u = b.defOffsetY, q = b.defOverflow, g = parseInt(f) - 265;
        0 > g && (g += d.width(), d.hide());
        j.css("width", g);
        this.fullScreen = function (b) {
            if ("not-support" == b) {
                a("body").css("overflow", "hidden");
                var b = a(window).width(), f = a(window).height();
                c.css("width", b);
                c.css("height", f);
                b = a(document).scrollLeft();
                f = a(document).scrollTop();
                parseInt(a("body").css("margin-left"));
                var g = parseInt(a("body").css("margin-top")), f = h - u + f - g + "px";
                c.css("left", i - B + b + "px");
                c.css("top", f)
            } else c.css("width", "100%"), c.css("height", "100%");
            b = parseInt(a(window).width()) - 265;
            0 > b ? (b += d.width(), d.hide()) : d.show();
            j.css("width", b)
        };
        this.normalScreen = function () {
            ...
            c.css("left", i);
            c.css("top", h);
            a("body").css("overflow", q);
            g = parseInt(f) - 265;
            0 > g ? (g += d.width(), d.hide()) : d.show();
            j.css("width", g)
        };
...
(function () {
    SewisePlayerSkin.TopBar = function (a) {
        var b = a.$topbar, c = a.$programTip, j = a.$programTitle, d = a.$topbarClock;
        setInterval(function () {
...
(function (a) {
    SewisePlayerSkin.ControlBar = function (b, c, j) {
        function d() {
            !1 == ca && (/*G.css("visibility", "visible"),*/ j.show(), ca = !0, D = setTimeout(h, da))
        }
        ...
        function B(a) {
            a = o + (a.pageX - H);
            0 < a && a < v && (w.css("width", a), r.css("left", a - N / 2))
        }

        function u(b) {
            x.unbind("mousemove", B);
            a(document).unbind("mouseup", u);
            V = b.pageX;
            H != V && (o = w.width(), I = o / v, k.seek(I * J));
            O = !1
        }

        function q(a) {
            e = a.originalEvent;
            1 == e.targetTouches.length && (e.preventDefault(), a = o + (e.targetTouches[0].pageX - H), 0 < a && a < v && (w.css("width", a), r.css("left", a - N / 2)))
        }

        function g(a) {
            e = a.originalEvent;
            r.unbind("touchmove", q);
            r.unbind("touchend", g);
            if (1 == e.changedTouches.length) V = e.changedTouches[0].pageX, H != V && (o = w.width(), I = o / v, k.seek(I * J));
            O = !1
        }

        function F(a) {
            a = l + (a.pageX - K);
            0 < a && a < s && (t.css("width", a), p.css("left", a - E / 2))
        }

        function m(b) {
            x.unbind("mousemove", F);
            a(document).unbind("mouseup", m);
            W = b.pageX;
            K != W && (l = t.width(), y = l / s, k.setVolume(y),
                U())
        }

        function n(a) {
            e = a.originalEvent;
            1 == e.targetTouches.length && (e.preventDefault(), a = l + (e.targetTouches[0].pageX - K), 0 < a && a < s && (t.css("width", a), p.css("left", a - E / 2)))
        }

        function A(a) {
            e = a.originalEvent;
            p.unbind("touchmove", n);
            p.unbind("touchend", A);
            if (1 == e.changedTouches.length) W = e.changedTouches[0].pageX, K != W && (l = t.width(), y = l / s, k.setVolume(y), U())
        }

        function T() {
            null != document.fullscreenElement || null != document.msFullscreenElement || null != document.mozFullScreenElement || null != document.webkitFullscreenElement ?
        ...
        function U() {
            0 < y ? (k.muted(!1), P.show(), L.hide()) : (k.muted(!0), P.hide(), L.show())
        }

        var x = b.$container, X = b.$video, G = b.$controlbar, Y = b.$playBtn, Q = b.$pauseBtn, ja = b.$stopBtn, Z = b.$fullscreenBtn, R = b.$normalscreenBtn, P = b.$soundopenBtn, L = b.$soundcloseBtn, t = b.$volumelineVolume, S = b.$volumelineDragger, p = b.$volumelinePoint, ka = b.$playtime, w = b.$progressPlayedLine, r = b.$progressPlayedPoint,
            la = b.$progressLoadedLine, M = b.$progressSeekLine, ea = b.$buffer, ma = b.$bufferTip, $ = b.$bigPlayBtn, z = this, k, fa = "normal", J = 0.1, C = 0, ha = "00:00:00", ia = "00:00:00", N = 0, O = !1, H = 0, V = 0, o = 0, v = 0, I = 0, ca = !0, E = 0, s = 0, l = 0, y = 0, K = 0, W = 0, aa = !1, D, da = 5E3, N = r.width(), v = M.width(), E = p.width(), s = S.width();
        Q.hide();
        R.hide();
        L.hide();
        ea.hide();
        D = setTimeout(h, da);
        a(X).css("pointer-events", "none");
        x.click(function () {
            x.mousemove();
            aa ? k.pause() : k.play()
        });
        x.dblclick(function () {
            // "normal" == fa ? z.fullScreen() : z.noramlScreen()
        });
        x.bind({
            mousemove: d,
            touchmove: d
        });
        G.bind({mouseover: f, touchstart: f});
        G.bind({mouseout: i, touchend: i});
        G.click(function (a) {
            a.originalEvent.stopPropagation()
        });
        Y.click(function () {
        ...
        p.bind("touchstart", function (a) {
            e = a.originalEvent;
            p.blur();
            K = e.targetTouches[0].pageX;
            l = t.width();
            s = S.width();
            p.bind("touchmove", n);
            p.bind("touchend", A)
        ...
        this.setDuration = function (a) {
            J = Infinity != a ? a : 3600;
            1 < a && (ia = SewisePlayerSkin.Utils.stringer.secondsToMS(J))
        };
        this.timeUpdate = function (a) {
            if (void 0 == a || Infinity == a) a = 0;
            C = a;
            ha = SewisePlayerSkin.Utils.stringer.secondsToMS(C);
            ka.text(ha + "/" + ia);
            O || (o = C / J * (M.width() - N), w.css("width", o+10), a = w.width(), r.css("left", a))
        };
        ...
        this.fullScreen = function () {
            ...
            R.show();
            var b = x.get(0);
            a(window).unbind("resize", ba);
            b.requestFullscreen ? b.requestFullscreen() : b.msRequestFullscreen ? b.msRequestFullscreen() : b.mozRequestFullScreen ? b.mozRequestFullScreen() : b.webkitRequestFullscreen ?
                            b.webkitRequestFullscreen() : X.webkitEnterFullscreen ? (X.play(), X.webkitEnterFullscreen(), Z.show(), R.hide()) : (c.fullScreen("not-support"), z.timeUpdate(C), a(window).bind("resize", ga));
            fa = "full"
        };
        this.noramlScreen = function () {
            Z.show();
            R.hide();
            document.exitFullscreen ? document.exitFullscreen() : document.msExitFullscreen ? document.msExitFullscreen() : document.mozCancelFullScreen ? document.mozCancelFullScreen() : document.webkitCancelFullScreen ? document.webkitCancelFullScreen() : (c.normalScreen(), z.timeUpdate(C),
                                a(window).unbind("resize", ga));
            fa = "normal";
            a(window).bind("resize", ba)
        };
...
(function (a, b) {
    b(document).ready(function () {
        var a = SewisePlayer.IVodPlayer, b = new SewisePlayerSkin.ElementObject, d = new SewisePlayerSkin.ElementLayout(b), f = new SewisePlayerSkin.LogoBox(b), i = new SewisePlayerSkin.TopBar(b), h = new SewisePlayerSkin.ControlBar(b, d, i);
        ...
        SewisePlayerSkin.IVodSkin.noramlScreen =
            function () {
                h.noramlScreen()
            };
