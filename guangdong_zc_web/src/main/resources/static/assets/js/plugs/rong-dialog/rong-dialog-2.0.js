...
var rongDialog = {
    ...
    change: function () {
        ...
        if (type == 3) {
            ...
            var showButtonPanel = "";
            if(m.opt.showButtonPanel){
                showButtonPanel = "<div style='text-align: center'><a style=\"border: 1px solid #999; display: inline-block; width: 100px; border-radius: 3px; height: 25px; line-height: 25px;\" href=\"javascript:void(0)\" id='rong_DIY_Dialog_close_btn'>关  闭</a></div>";
            }

            var panelHTML = "<div class=\"rong_DIY_Dialog r_none\"><a href=\"javascript:void(0)\" class=\"r_close js__r_close\" title=\"关闭\"></a>" + $(m.opt.panelDIV).prop("outerHTML") + showButtonPanel + "</div>" +
                "<div class=\"r_mask\"></div>";
        ...
        if (type == 3) {
            ...
            if(m.opt.showButtonPanel){
                $('#rong_DIY_Dialog_close_btn').click(function(){
                    m.closeMaskPanel();
                    if($.isFunction(m.opt.closeFn()))m.opt.closeFn();
                });
            }
        }
        if (type == 5) {
