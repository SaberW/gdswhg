package hn.creatoo.com.web.actions.web.fagui;
 ...
 */
@Controller
@RequestMapping(value = "/{cultsite}/fagui")
public class FaGuiAction {
    //包装页面头部SEO信息
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-法律法规";
    ...
    public ModelAndView toList(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ...
        modelAndView.setViewName("guangdong/fagui/list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"法律法规列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        request.setAttribute("cultsite",cultsite);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/fagui/detail");
        this.setCommcontent(modelAndView,"法律法规详情",null,null);
        return modelAndView;
    }
}
