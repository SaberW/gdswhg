package hn.creatoo.com.web.actions.web.zcbrand;
...
public class BrandAction {
    ...
    public ModelAndView toList(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ...
        modelAndView.setViewName("guangdong/zcbrand/list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"众筹品牌列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        request.setAttribute("cultsite",cultsite);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong/zcbrand/detail");
        this.setCommcontent(modelAndView,"众筹品牌详情",null,null);
        return modelAndView;
    }
}
