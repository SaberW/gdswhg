...
//	private WhgYwiKeyMapper whgYwiKeyMapper;
	 ...
	 */
//	@Autowired
//    private WhgSerialnoMapper whSerialnoMapper;
...
//
//		//根据表名和日期查询当前值
//		WhgSerialno whSerialno = null;
//		Example example = new Example(WhgSerialno.class);
//		example.createCriteria().andEqualTo("tname", tname).andEqualTo("cdate", cdate);
//		List<WhgSerialno> lst = this.whSerialnoMapper.selectByExample(example);
...
//
//		//删除非当日的数据
//		Example example2 = new Example(WhgSerialno.class);
