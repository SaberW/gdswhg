...
import com.creatoo.hn.utils.RequrestParamsUtil;
...
public class WhgSystemUserService {
    ...
    public PageInfo<WhgSysUser> t_srchList4p(HttpServletRequest request, WhgSysUser cult)throws Exception{
        Map<String, Object> paramMap = RequrestParamsUtil.parseRequest(request);
...
//                ur.setDelstate(EnumStateDel.STATE_DEL_NO.getValue());
...
//                uc.setDelstate(EnumStateDel.STATE_DEL_NO.getValue());
