package hn.creatoo.com.web.actions.train.login;
...
public class GxLoginAction {
     ...
     * @return
     */
    @RequestMapping("/{cultsite}/doLogin")
     ...
     * @return
     */
    @RequestMapping("/{cultsite}/doLogout")
