...
public class CommInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        jsonObject.put("delFav",rootUrl + "api/collection/delMyColle"); //取消用户收藏  POST
        jsonObject.put("delListFav",rootUrl + "api/collection/delMyColle"); //取消列表收藏  POST
        ...
        jsonObject.put("openDays",rootUrl+"api/inside/train/openDays");//供需插件(天数集)
        jsonObject.put("firstOpenYMD",rootUrl+"api/inside/train/firstOpenYMD");//供需插件(最近的年月日)
        jsonObject.put("getgxcity",rootUrl+"api/inside/train/getgxcity");//可配送的范围
        jsonObject.put("getSupplyInfo",rootUrl+"api/inside/train/info");//配送基本信息
        jsonObject.put("addDelivery",rootUrl+"api/inside/delivery/addDelivery");//申请配送

        jsonObject.put("depts",rootUrl+"api/comm/getDepts");//获取部门
        jsonObject.put("validLogin",rootUrl+"api/inside/validLogin");//内部供需登录接口
        jsonObject.put("supplyList",rootUrl+"api/inside/train/list");//供需列表查询
        jsonObject.put("supplyInfo",rootUrl+"api/inside/train/info");//供需列表详情
        jsonObject.put("supplyTimeList",rootUrl+"api/inside/train/timeList");//供需配送时间列表
        jsonObject.put("supplyInfoMatchList",rootUrl+"api/inside/train/infoMatchList");//供需推荐列表
        jsonObject.put("supplyGetGxCity",rootUrl+"api/inside/train/getgxcity");//供需配送范围
        jsonObject.put("canApply",rootUrl+"api/inside/train/canApply");//检测能否申请
        ...
        jsonObject.put("supplyMsgList",rootUrl+"api/message/list");//我的消息
        jsonObject.put("msgDel",rootUrl+"api/message/remove");//删除消息
        ...
        jsonObject.put("indexTraList",rootUrl+"api/px/indexTraList");//线下培训
        jsonObject.put("indexTraliveList",rootUrl+"api/px/indexTraliveList");//在线课程
        jsonObject.put("indexTraMajorList",rootUrl+"api/px/major/list");//微专业
        jsonObject.put("majorDetail",rootUrl+"api/px/major/detail");//微专业详情
        jsonObject.put("majortea",rootUrl+"api/px/major/getTea");//获取微专业的关联师资
        jsonObject.put("majortra",rootUrl+"api/px/major/getTra");//获取微专业的关联课程
        jsonObject.put("majordrsc",rootUrl+"api/px/major/getDrsc");//获取微专业的关联资源
        jsonObject.put("pxList",rootUrl+"api/px/list");//普通培训
        jsonObject.put("teaList",rootUrl+"api/px/tea/list");//师资列表
        jsonObject.put("teaDetail",rootUrl+"api/px/tea/detail");//师资详情
        jsonObject.put("teatra",rootUrl+"api/px/tea/getRecommendTea");//师资相关培训

        jsonObject.put("drscList",rootUrl+"api/px/drsc/list");//资源列表

        jsonObject.put("getTypes",rootUrl+"api/comm/getTypes");//培训列表

        jsonObject.put("pxState",rootUrl+"api/px/checkState");//培训状态
        jsonObject.put("pxDetail",rootUrl+"api/px/detail"); //培训详情

        jsonObject.put("pxCourse",rootUrl+"api/px/course");//课程表

        jsonObject.put("getEnrolPerson",rootUrl+"api/px/getEnrolPerson");//培训人员

        jsonObject.put("getRecommendTra",rootUrl+"api/px/getRecommendTra");//推荐培训

        jsonObject.put("checkEnrol",rootUrl+"api/px/checkEnrol");//验证用户是否可报名

        jsonObject.put("enrol",rootUrl+"api/px/enrol");//报名

        jsonObject.put("mytraList",rootUrl+"api/px/mytra/list"); //我的培训

        jsonObject.put("traDescDetail",rootUrl+"api/tra/descDetail"); //资源详情

        jsonObject.put("getRecommendDesc",rootUrl+"api/px/drsc/getRecommendDesc"); //资源推荐

        jsonObject.put("offenroll",rootUrl+"api/px/mytra/offenroll ");//取消删除订单

        jsonObject.put("userEditinfo",rootUrl+"api/user/editinfo ");//编辑用户资料
        jsonObject.put("getUserEditInfo",rootUrl + "api/user/info");  //获取用户信息 POST

        jsonObject.put("traliveRecommend",rootUrl+"api/zxkc/recommends");//在线课程推荐列表

        jsonObject.put("myCollect",rootUrl+"api/px/mytra/myCollect");//收藏列表

        jsonObject.put("resourceList",rootUrl+"api/comm/resource");//培训资源列表

        //课程表-JackyZeng
        jsonObject.put("traliveList",rootUrl+"api/px/mytra/nowkecheng");//当前课程
        jsonObject.put("mytraCenterList",rootUrl+"api/px/mytra/mytraList");//所有培训
        jsonObject.put("kecheng",rootUrl+"api/px/mytra/kecheng");//每个培训的所有课程
        jsonObject.put("inClass",rootUrl+"api/px/mytra/inClass");//正在上课课程
        jsonObject.put("leave",rootUrl+"api/px/mytra/leave");//请假

        //网络培训-在线课程接口-wangxl
        jsonObject.put("myvisitnote", rootUrl+"static/admin/js/pc.js?type=1");//当前课程
        jsonObject.put("nowkecheng",rootUrl+"api/zxkc/list");//当前课程
        jsonObject.put("traliveDetail",rootUrl+"api/zxkc/detail");//所有培训
        jsonObject.put("traliveInfo",rootUrl+"api/zxkc/live");//每个培训的所有课程
        jsonObject.put("traliveRecommend",rootUrl+"api/zxkc/recommends");//正在上课的课程

        jsonObject.put("province","广东省");//设置省份

        jsonObject.put("cultdetail",rootUrl + "api/whglm/whgdetail"); //获取文化馆详情  POST

        jsonObject.put("xgzxList",rootUrl+"/api/comm/glzx");//先关资讯
        jsonObject.put("infcolumn",rootUrl+"api/information/infcolumn");//获取资讯类型
        jsonObject.put("infolist",rootUrl+"api/information/infolist");//获取资讯列表
        jsonObject.put("infoldetail",rootUrl+"api/information/infoldetail");//获取资讯详情
