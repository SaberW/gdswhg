package hn.creatoo.com.web.actions.train.index;
...
public class IndexActionGx {
    ...
    public ModelAndView toIndexGx(HttpServletRequest request,HttpSession session,@PathVariable("cultsite") String cultsite){
    ...
    @RequestMapping(value = "/{cultsite}/about")
    public ModelAndView toAbout(HttpServletRequest request,HttpSession session,@PathVariable("cultsite") String cultsite){
        request.setAttribute("cultsite",cultsite);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/guangdong_gx/about");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"关于我们",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/{cultsite}/contact")
    public ModelAndView toContact(HttpServletRequest request,HttpSession session,@PathVariable("cultsite") String cultsite){
        request.setAttribute("cultsite",cultsite);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("/guangdong_gx/contact");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"联系我们",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/{cultsite}", method = {RequestMethod.GET})
    public ModelAndView toIndexGx3(HttpServletRequest request,HttpSession session,@PathVariable("cultsite") String cultsite){
        ModelAndView modelAndView = new ModelAndView();
