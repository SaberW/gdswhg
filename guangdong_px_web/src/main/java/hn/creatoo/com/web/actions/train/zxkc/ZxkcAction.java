package hn.creatoo.com.web.actions.train.zxkc;
 ...
 */
@Controller
@RequestMapping(value = "/{cultsite}/zxkc")
public class ZxkcAction {

    //包装页面头部SEO信息
    private void setCommcontent(ModelAndView mv,String title,String desc,String key){
        String pageTitle = "文化在线-广东公共数字文化联盟-在线课程";
    ...
    public ModelAndView toList(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        ...
        modelAndView.setViewName("guangdong_gx/zxkc/list");
        request.setAttribute("qh",true);
        this.setCommcontent(modelAndView,"在线课程列表",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toDetail(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        request.setAttribute("cultsite",cultsite);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/zxkc/detail");
        this.setCommcontent(modelAndView,"在线课程详情",null,null);
        return modelAndView;
    }

    @RequestMapping(value = "/live")
    public ModelAndView toLive(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        request.setAttribute("cultsite",cultsite);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/zxkc/live");
        this.setCommcontent(modelAndView,"在线播放",null,null);
        return modelAndView;
    }
    ...
    public ModelAndView toStep(HttpServletRequest request,@PathVariable("cultsite") String cultsite){
        request.setAttribute("cultsite",cultsite);
        ModelAndView modelAndView = new ModelAndView();
        modelAndView.setViewName("guangdong_gx/zxkc/step");
