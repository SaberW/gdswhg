...
RoomOrderTool.prototype = {
    ...
    buttonSubmit: function(){
        ...
        window.location.href = this.settings.basePathHeader+'/cg'+'/'+[[${cultsite}]]+'/venueliucheng?roomtimeid='+this.selectValue.id+'&timeday='+this.selectValue.timeday+'&timestart='+this.selectValue.timestart+'-'+this.selectValue.timeend+'&roomId='+this.settings.roomId;
    },
