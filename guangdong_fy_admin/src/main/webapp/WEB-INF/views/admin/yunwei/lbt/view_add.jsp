...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input" style="width: 75%">
            <input class="easyui-combobox" name="cultid" id="cultid" style="width:90%; height:32px" panelHeight="auto" data-options="prompt:'请选择文化馆', required:true">
        </div>
    </div>
    ...
    <div class="whgff-row"  refField="toproject">
        ...
        <div class="whgff-row-input" data-check="true" target="toproject" err-msg="请至少选择一个系统">
            <div class="checkbox checkbox-primary whg-js-data" name="toproject" value=""   js-data="WhgComm.getFromProject">
            </div>
        </div>
    </div>
...
<script>
    $(function () {
        WhgComm.initPMS({cultEid:'cultid', cultValue:""});
        var lbt_type = '${clazz}';
        if( lbt_type == '1' ){
