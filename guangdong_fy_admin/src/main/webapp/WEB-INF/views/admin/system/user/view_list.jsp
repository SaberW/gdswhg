...
<table id="whgdg" title="管理员管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', queryParams:{cultid: WhgComm.getMgrCultsAndChild()[0].id}, url:'${basePath}/admin/system/user/srchList4p'">
    <thead>
    <tr>
        <th data-options="field:'ck', checkbox:true"></th>
        <th data-options="field:'account', width:100">账号</th>
        <th data-options="field:'contactnum', width:100">手机号</th>
        <th data-options="field:'lastlogintime', width:100, formatter:WhgComm.FMTDateTime">最后登录时间</th>
