...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        <form id="whgdg-tb-srch-form">
            ...
            <input class="easyui-combobox" style="width: 200px;" name="cultid" data-options="required:true, prompt:'请选择文化馆', value:WhgComm.getMgrCultsAndChild()[0].id, valueField:'id', textField:'text', data:WhgComm.getMgrCultsAndChild()"/>
