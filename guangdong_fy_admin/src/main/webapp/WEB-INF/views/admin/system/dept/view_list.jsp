...
<table id="whgdg" title="部门管理" class="easyui-treegrid" style="display: none"
       data-options="fit:true, rownumbers:true, fitColumns:true, singleSelect:true, loadFilter:myLoadFilter, idField:'id', treeField:'name', toolbar:'#whgdg-tb', queryParams:{cultid: WhgComm.getMgrCultsAndChild()[0].id}, url:'${basePath}/admin/system/dept/srchList4p'">
    <thead>
    <tr>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        <form id="whgdg-tb-srch-form">
            <input class="easyui-combobox" style="width: 200px;" name="cultid" id="srch_cultid" data-options="required:true, prompt:'请选择文化馆', value:WhgComm.getMgrCultsAndChild()[0].id, valueField:'id', textField:'text', data:WhgComm.getMgrCultsAndChild()"/>
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-search" onclick="queryDept()">查 询</a>
        </form>
    </div>
</div>
<!-- 表格操作工具栏-END -->
    ...
    <form id="whgff" class="whgff" method="post">
        ...
        <div class="whgff-row">
            ...
            <div class="whgff-row-input" style="width: 75%">
                <input class="easyui-combobox" style="width:550px; height:32px" name="cultid" id="whgff_cultid" data-options="required:true, prompt:'请选择文化馆', valueField:'id', textField:'text', data:WhgComm.getMgrCultsAndChild()"/>
            </div>
        </div>
        <div class="whgff-row">
        ...
        <div class="whgff-row">
            <div class="whgff-row-label" style="width: 25%"><i>*</i>简介：</div>
            <div class="whgff-row-input" style="width: 75%"><input class="easyui-textbox" id="whgff-row-input-summary" name="summary" style="width:550px; height:80px" data-options="multiline:true, prompt:'请输入简介', required:true, validType:'length[1,2000]'"></div>
        </div>
    </form>
</div>
...
<script type="text/javascript">
     ...
     **/
    function queryDept(){
        if($('#whgdg-tb-srch-form').form('validate')){
            $('#whgdg').treegrid('load', {cultid:$('#srch_cultid').combobox('getValue')});
        }
    }
