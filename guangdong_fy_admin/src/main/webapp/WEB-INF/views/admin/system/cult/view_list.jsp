...
<!-- 表格 -->
<table id="whgdg" title="子馆管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', queryParams:{pid: WhgComm.getMgrCults()[0].id},  url:'${basePath}/admin/system/cult/srchList4p'">
    <thead>
    <tr>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        <form id="whgdg-tb-srch-form">
            ...
            <input class="easyui-combobox" style="width: 200px;" name="pid" data-options="required:true, prompt:'请选择上级文化馆', value:WhgComm.getMgrCults()[0].id, valueField:'id', textField:'text', data:WhgComm.getMgrCults()"/>
...
<div id="whgdg-opt" style="display: none;">
    ...
    <shiro:hasPermission name="${resourceid}:edit"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="sqstate" validVal="1" method="doCheckTrue">审核通过</a></shiro:hasPermission>
    <shiro:hasPermission name="${resourceid}:edit"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="sqstate" validVal="1" method="doCheckFalse">审核不通过</a></shiro:hasPermission>
    <shiro:hasPermission name="${resourceid}:off"> <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="canStop"  method="doOff">停用</a></shiro:hasPermission>
    <shiro:hasPermission name="${resourceid}:on">  <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="canStart"  method="doOn">启用</a></shiro:hasPermission>
...
<script type="text/javascript">
     ...
     * @private
     */
    function _doUpdSqState(ids, fromState, toState){
        $.ajax({
            url: getFullUrl('/admin/system/cult/updsqstate'),
            data: {ids:ids, fromState:fromState, toState:toState},
            cache: false,
            success: function (data) {
                if(data && data.success == '1'){
