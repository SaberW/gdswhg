...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-combobox" style="width: 300px; height:32px" name="cultid" data-options="required:true, prompt:'请选择文化馆', value:WhgComm.getMgrCultsAndChild()[0].id, valueField:'id', textField:'text', data:WhgComm.getMgrCultsAndChild()"/>
        </div>
    </div>
