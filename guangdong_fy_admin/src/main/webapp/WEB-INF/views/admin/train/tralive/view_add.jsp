    ...
    <script>
        ...
        $.extend($.fn.validatebox.defaults.rules, {
            traTime: {
                ...
                message: '直播时间必须在培训周期之内，结束时间大于开始时间，各直播时间段不能重合。'
            },
            bmEndTime: {
                validator: function(value, param){
            ...
            sinTime:{
                ...
                message: '直播结束时间必须大于开始时间,并且必须大于报名结束时间'
            },
            oneDay:{
                validator: function(value, param){
                    var sdVal = $('#'+param[0]).datetimebox('getValue');
   ...
   <div class="whgff-row">
    ...
    <div class="whgff-row single" >
        ...
        <div class="whgff-row-input">
            ...
            <input class="easyui-datetimebox sin_endtime" id="sin_endtime" name="sin_endtime" style="width:200px; height:32px" data-options="validType:['sinTime[\'sin_starttime\']', 'oneDay[\'sin_starttime\']']"/>
        </div>
    </div>
