...
<div id="whgdg-opt" style="display: none;">
    ...
    <c:if test="${isbasicclass == 2}">
        <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="state" validVal="6" method="s_sign">签到</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="state" validVal="6" method="s_toleave">请假</a>
    </c:if>
    <c:if test="${isbasicclass == 2}">
...
<div id="whgdg-opt1" style="display: none;">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="state" validVal="6" method="toleave">请假</a>
</div>
<!-- 操作按钮-END -->
...
<script>
    ...
    function validSign(idx){
        ...
        //alert(row);
        return row.sign != 1 &&  row.vstate != 1;
    }
