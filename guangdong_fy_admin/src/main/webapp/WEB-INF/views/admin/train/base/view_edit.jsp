...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red"></label>文化品牌2：</div>
        <div class="whgff-row-input">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <div class="radio radio-primary whg-js-data" value="${whgTra.noticetype}" name="noticetype" id="noticetype"
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="duration" value="${whgTra.duration}" style="width:500px; height:32px" data-options="validType:['length[1,100]'],prompt:'请填写培训时长'">
        </div>
    </div>
