...
<head>
    ...
    <script>
		...
		function setBranch() {
            $.getJSON("${basePath}/admin/system/cult/branchList?state=1&pid=0000000000000000",function (data) {
//                debugger;
                if("1" != data.success){
...
<script>
	...
	function myChangeCity(newVal, oldVal) {
		...
		if(__init_area){
			window.setTimeout(function () {$('#__AREA_ELE').combobox('setValue', '${act.area}')}, 500);
			__init_area = false;
		}
	}  //省市区------END
