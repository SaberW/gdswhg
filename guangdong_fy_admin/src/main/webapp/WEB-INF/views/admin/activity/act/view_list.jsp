...
<table id="whgdg" title="文化活动管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', queryParams:{cultid: WhgComm.getMgrCults()[0].id},url:'${basePath}/admin/activity/srchList4p?__pageType=${type}'">
    <thead>
    <tr>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-combobox" name="cultid" id="cultid" style="width:200px;" panelHeight="auto" data-options="prompt:'请选择文化馆',required:true">
...
<div id="whgdg-opt" style="display: none;">
    ...
    <shiro:hasPermission name="${resourceid}:ziyuan"><a href="javascript:void(0)" class="easyui-linkbutton" plain="true" method="doResource">资源管理</a></shiro:hasPermission>
    ...
    <shiro:hasPermission name="${resourceid}:bigbannered"> <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="validBannerOn" method="doBigBanner">推荐上大首页</a></shiro:hasPermission>
    <shiro:hasPermission name="${resourceid}:bigbanneroff"> <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validFun="validBannerOff" method="bigBannerOff">取消上大首页</a></shiro:hasPermission>
...
<script type="text/javascript">
    ...
    function doEdit(idx) {
        var curRow = $('#whgdg').datagrid('getRows')[idx];
        WhgComm.editDialog('${basePath}/admin/activity/view/edit?id='+curRow.id);
    }
    ...
    function doResource(idx) {
        ...
        WhgComm.editDialog('${basePath}/admin/resource/view/list?reftype=2&refid=' + curRow.id+'&cultid='+cultid);
    }
