...
<body class="easyui-layout">
    ...
    <div style="display:none" data-options="region:'center',title:'',iconCls:'icon-ok'">
        <table id="whgdg" class="easyui-datagrid" title="${pageTitle}" style="display: none;"
               ...
               data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, queryParams:{cultid: WhgComm.getMgrCults()[0].id},url:'${basePath}/admin/information/seleinfo'">
            <thead>
            <tr>
...
<script>
    ...
    var tool = (function(){
        ...
        function treeOnselect(node){
            ...
            //初始表格数据
            grid = $("#whgdg").datagrid({
                url : '${basePath}/admin/information/seleinfo',
    ...
    var whgListTool = {
        ...
        add: function(){
            ...
            WhgComm.editDialog('${basePath}/admin/information/view/add?clnftype='+nowColid);
        },
