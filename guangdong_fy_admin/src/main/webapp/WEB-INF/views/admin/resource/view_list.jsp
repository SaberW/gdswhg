...
<table id="whgdg" title="资源管理" class="easyui-datagrid" style="display: none"
       data-options="
            ...
            selectOnCheck:true,
            pagination:true,
            toolbar:'#whgdg-tb', url:'${basePath}/admin/resource/srchList4p?refid=${refid}&reftype=${reftype}'">
    <thead>
    <tr>
        <%--<th data-options="field:'entid', width:60">资源ID</th>--%>
        <th data-options="field:'name', width:60">资源名</th>
        ...
        <th data-options="field:'reftype',width:60,formatter:WhgComm.FMTResourceType">实体类型</th>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        <input class="easyui-textbox" style="width: 200px; height:26px" name="name" data-options="prompt:'资源名称'" />
...
<script>
    ...
    function doEdit(idx) {
        ...
        var cultid = '${param.cultid}';
        WhgComm.editDialog('${basePath}/admin/resource/view/edit?id=' + curtRow.id+'&cultid='+cultid);
    }
    /** 编辑资源方法-END */
