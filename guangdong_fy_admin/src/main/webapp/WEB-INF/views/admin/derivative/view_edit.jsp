	...
	<form id="whgff" method="post" class="whgff">
		...
		<div class="whgff-row">
			...
			<div class="whgff-row-input">
				<input class="easyui-textbox" name="name" value="${derivative.name}"
		...
		<div class="whgff-row">
			...
			<div class="whgff-row-input">
				<input type="hidden" id="cult_picture1" name="picture" value="${derivative.picture}">
		...
		<div class="whgff-row">
			...
			<div class="whgff-row-input">
				<div class="radio radio-primary whg-js-data" name="type" id="type" value="${derivative.type}"
		...
		<div class="whgff-row">
			<div class="whgff-row-label"><label style="color: red">*</label>非遗类型：</div>
			<div class="whgff-row-input"><input class="easyui-combobox" name="etype" value="${derivative.etype}" style="height:32px;width: 500px"
		...
		<div class="whgff-row">
			...
			<div class="whgff-row-input">
				<input class="easyui-textbox" name="producer" value="${derivative.producer}"
...
<script>
    ...
    ue_catalog.ready(function () {
        ue_catalog.setContent('${derivative.introduction}')
    });
    ...
    $(function () {
        ...
        $('#whgff').form({
            novalidate: true,
            url: "${basePath}/admin/derivative/edit",
