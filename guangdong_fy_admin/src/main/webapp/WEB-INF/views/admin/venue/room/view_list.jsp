...
<jsp:include page="../../fkproject/fkproject_condition.jsp"/>
    ...
    <div id="tb" style="display: none;">
        ...
        <input class="easyui-combobox" name="venid" panelHeight="auto" limitToList="true" prompt="请选择所属场馆"
        ...
        <input class="easyui-combobox" name="venid" id="venid" prompt="请选择所属场馆"
...
<script>
    ...
    Gridopts.prototype.paramLoader = function (param, success, error) {
        ...
        $.ajax({
            url: '${basePath}/admin/venue/room/srchList4p?pageType=${pageType}',
            data : param,
            dataType: 'json',
            success: success,
            error: error
