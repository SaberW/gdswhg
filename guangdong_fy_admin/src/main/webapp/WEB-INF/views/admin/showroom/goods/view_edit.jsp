	...
	<form id="whgff" method="post" class="whgff">
		...
		<div class="whgff-row">
			...
			<div class="whgff-row-input">
				<input class="easyui-textbox" name="title" value="${goods.title}"
		...
		<div class="whgff-row">
			...
			<div class="whgff-row-input">
				<input class="easyui-textbox" name="author" value="${goods.author}"
					   style="width: 500px; height: 32px" data-options="required:true,validType:['length[1,40]']" />
			</div>
		</div>
		...
		<div class="whgff-row">
			...
			<div class="whgff-row-input">
	            <input type="hidden" id="imgurl" name="image" value="${goods.image}">
...
ue_catalog.ready(function () {
	ue_catalog.setContent('${goods.cowrydesc}')
});
...
$(function () {
    ...
    $('#whgff').form({
        novalidate: true,
        url: "${basePath}/admin/fygoods/edit",
