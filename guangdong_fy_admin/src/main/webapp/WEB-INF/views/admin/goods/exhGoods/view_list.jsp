...
<body>
<table id="whgdg" class="easyui-datagrid" title="展品列表" style="display: none;"
       pagination=true pageSize=30 pageList="[10,20,30,50,100,200]" loadMsg="数据加载中，请稍候。。。"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:true, checkOnSelect:true, selectOnCheck:true, toolbar:'#whgdg-tb',queryParams:{cultid: WhgComm.getMgrCultsAndChild()[0].id},url:'${basePath}/admin/exhGoods/srchList4p'">
    <thead>
    <tr>
        <th data-options="width:100, sortable:false, field:'title' ">展品名称</th>
        <th data-options="width:100, sortable:false, field:'etype', formatter:WhgComm.FMTExhGoodsType">展品类型</th>
        <th data-options="width:100, sortable:false, field:'author' ">作者</th>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-textbox" name="title" prompt="请输入展品名称" data-options="width:120">
...
<div id="whgdg-opt" style="display: none;">
    ...
    <shiro:hasPermission name="${resourceid}:edit"><a plain="true" method="resource">资源管理</a></shiro:hasPermission>
...
<script>
     ...
     */
    function add(){
        WhgComm.editDialog('${basePath}/admin/exhGoods/view/edit');
    }
    ...
    function edit(idx){
        ...
        WhgComm.editDialog('${basePath}/admin/exhGoods/view/edit?pageType=1&id='+row.id);
    }
    ...
    function view(idx){
        var row = $("#whgdg").datagrid("getRows")[idx];
        WhgComm.editDialog('${basePath}/admin/exhGoods/view/edit?pageType=2&id='+row.id);
    }
    ...
    function publish(idx){
        ...
        $('#whgwin-add').dialog({
            ...
            onOpen: function () {
                ...
                $('#whgff').form({
                    url : '${basePath}/admin/exhGoods/updstate',
    ...
    function __updStateSend(ids, formstates, tostate){
        ...
        $.post('${basePath}/admin/exhGoods/updstate', params, function(data){
            $("#whgdg").datagrid('reload');
    ...
    function del(idx){
        ...
        $.messager.confirm("确认信息", confireStr, function(r){
            if (r){
                $.messager.progress();
                $.post('${basePath}/admin/exhGoods/del', {id: row.id}, function(data){
                    $("#whgdg").datagrid('reload');
                    if (!data.success || data.success != "1"){
                        $.messager.alert("错误", data.errormsg||'操作失败', 'error');
                    }
    ...
    function resource(idx) {
        ...
        WhgComm.editDialog('${basePath}/admin/resource/view/list?reftype=22&refid=' + row.id+"&cultid="+cultid);
    }
