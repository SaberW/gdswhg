...
<head>
    ...
    <c:choose>
        <c:when test="${pageType eq '2'}">
            <c:set var="pageTitle" value="组织机构管理-查看组织机构"></c:set>
        </c:when>
        <c:when test="${pageType eq '1'}">
            <c:set var="pageTitle" value="组织机构管理-编辑组织机构"></c:set>
        </c:when>
        <c:otherwise>
            <c:set var="pageTitle" value="组织机构管理-添加组织机构"></c:set>
        </c:otherwise>
    </c:choose>
...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>机构法人：</div>
        <div class="whgff-row-input">
