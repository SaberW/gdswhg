...
<table id="whgdg" class="easyui-datagrid" title="展览类商品列表" style="display: none;"
       pagination=true pageSize=30 pageList="[10,20,30,50,100,200]" loadMsg="数据加载中，请稍候。。。"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:true, checkOnSelect:true, selectOnCheck:true, toolbar:'#whgdg-tb', queryParams:{cultid: WhgComm.getMgrCultsAndChild()[0].id},url:'${basePath}/admin/showExh/srchList4p'">
    <thead>
    <tr>
        <th data-options="sortable:false, field:'title' ">展览名称</th>
        <th data-options="sortable:false, field:'etype',formatter:WhgComm.FMTExhType ">展览类型</th>
        <th data-options="sortable:false, field:'exhcontacts' ">联系人</th>
        <th data-options="sortable: true, field:'exhphone' ">联系方式</th>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-textbox" name="title" prompt="请输入展览类商品名称" data-options="width:120">
...
<script>
     ...
     */
    function add(){
        WhgComm.editDialog('${basePath}/admin/showExh/view/edit');
    }
    ...
    function edit(idx){
        ...
        WhgComm.editDialog('${basePath}/admin/showExh/view/edit?pageType=1&id='+row.id);
    }
    ...
    function view(idx){
        var row = $("#whgdg").datagrid("getRows")[idx];
        WhgComm.editDialog('${basePath}/admin/showExh/view/edit?pageType=2&id='+row.id);
    }
