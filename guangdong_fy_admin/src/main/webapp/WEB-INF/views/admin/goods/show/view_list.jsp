...
<table id="whgdg" class="easyui-datagrid" title="演出节目列表" style="display: none;"
       pagination=true pageSize=30 pageList="[10,20,30,50,100,200]" loadMsg="数据加载中，请稍候。。。"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:true, singleSelect:false, checkOnSelect:true, selectOnCheck:true, toolbar:'#whgdg-tb',queryParams:{cultid: WhgComm.getMgrCultsAndChild()[0].id},url:'${basePath}/admin/showGoods/srchList4p'">
    <thead>
    <tr>
        <th data-options="width:100, sortable:false, field:'title' ">名称</th>
        <%--<th data-options="width:100, sortable:false, field:'organ' ">所属机构</th>--%>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <input class="easyui-textbox" name="title" prompt="请输入商品名称" data-options="width:120">
...
<script>
     ...
     */
    function add(){
        WhgComm.editDialog('${basePath}/admin/showGoods/view/edit');
    }
    ...
    function edit(idx){
        ...
        WhgComm.editDialog('${basePath}/admin/showGoods/view/edit?pageType=1&id='+row.id);
    }
    ...
    function view(idx){
        var row = $("#whgdg").datagrid("getRows")[idx];
        WhgComm.editDialog('${basePath}/admin/showGoods/view/edit?pageType=2&id='+row.id);
    }
