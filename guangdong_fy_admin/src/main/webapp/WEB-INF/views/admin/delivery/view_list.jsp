...
<table id="whgdg" class="easyui-datagrid" title="配送审核列表" style="display: none;"
    ...
    <tr>
        ...
        <th data-options="width:100, sortable:false, field:'fktype',formatter:WhgComm.FMTFkType ">类型</th>
        <c:choose>
            <c:when test="${clazz == 0}">
...
<div id="whgdg-tb" style="display: none;">
    <div class="whgdg-tb-srch" style="padding-top: 8px">
        ...
        <select class="easyui-combobox" name="fktype" prompt="请选择配送类型" panelHeight="auto" limitToList="true"
                data-options="width:120, value:'', valueField:'id', textField:'text', data:WhgComm.getFkType()">
        </select>
        <c:choose>
            <c:when test="${clazz == 0}">
