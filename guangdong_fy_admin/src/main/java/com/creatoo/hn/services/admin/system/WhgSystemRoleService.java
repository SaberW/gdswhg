...
import com.creatoo.hn.dao.mapper.admin.system.WhgSysRolePmsCustomMapper;
...
public class WhgSystemRoleService extends BaseService {
     ...
     */
    @Autowired
    private WhgSysRolePmsCustomMapper whgSysRolePmsCustomMapper;
    ...
    public WhgSysRole t_add(WhgSysRole cult, String[] pms, WhgSysUser user)throws Exception{
        ...
        if(pms != null){
            ...
            this.whgSysRolePmsCustomMapper.batchInsert(srpList);
        }
