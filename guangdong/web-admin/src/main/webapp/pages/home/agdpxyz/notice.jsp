            ...
            if (data.code == 0) {
                if (data.rows.length > 0) {
                    for (var i in data.rows) {
                        ...
                        infoHtml+='<a target="_blank" href="${apiZxpx}${apiSite}/pxzx/detail?id='+model.clnfid+'">'+model.clnftltle+'</a>';
                        infoHtml+='</h2>';
                        infoHtml+='<p>'+model.clnfintroduce+'</p>';
                        infoHtml+='<span class="more"><a target="_blank" href="${apiZxpx}${apiSite}/pxzx/detail?id='+model.clnfid+'">查看详情</a></span>';
                        infoHtml+='</div></div></li>';
                    }
                }else {
