                        ...
                        if (data.status == "1") {
                            ...
                            if ('activity' == data.type) {
                                ...
                                for(var i=0;sseat.length>i;i++){
                                    if(sseat[i]!=""){
                                        $("#qrcodeImg_div").append("<div style='display: none' id='"+ids+sseat[i]+"1'></div>");
                                        createCodeImage(ids,sseat[i]); //生成二维码
                                    }
                                }
                                var timer2 = setTimeout(hideDialog3, 100);
                                var num = 3;
                            ...
                            if ('venue' == data.type) {
                                ...
                                var timer4 = setTimeout(hideDialog4, 100);
                                var num = 3;
...
//            $(".ticket-content").css("height", winH - topH);
        ...
        function createCodeImage1(ids,code) {
...
<div  id="qrcodeImg_div" style="display: none;"></div>
<!-- 场馆打印 -->
...
<script language="javascript" type="text/javascript">
                    ...
                    if(str[i]!=""){
                        if(printPiao.indexOf("[piaoInfo]")!=-1){
                            ...
                            if(strFormHtml.indexOf("[qrcodeImgdiv]")!=-1){
                                strFormHtml=strFormHtml.replace("[qrcodeImgdiv]",document.getElementById(id+sseat[i]+"1").innerHTML);
                            }
                            LODOP.SET_PRINT_MODE("CUSTOM_TASK_NAME","票务打印"+i);//为每个打印单独设置任务名
    ...
    function printVenue() {
        try{
            ...
            LODOP.SET_PRINT_MODE("CUSTOM_TASK_NAME","活动室打印");//为每个打印单独设置任务名
            //		LODOP.PREVIEW();
            LODOP.PRINT();
            $("#orderValidateCode").val('');
        }catch (e){
