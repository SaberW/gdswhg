...
function loadData(){
    ...
    $.ajax({
        url: 'http://www.gdzyz.cn/api/index/getIndexStatistics',
        type: "GET",
        data: {
            'districtId': '402800e245df56eb0145dfd7d6bb0043'
        },
        success: function (data) {
            var res=data.data;
            $(".number > div.num:eq(0) > span").text(res.sumServicetime);
            $(".number > div.num:eq(1) > span").text(res.countUser);
            $(".number > div.num:eq(2) > span").text(res.countSocialOrg);
        }
...
<div class="main-info-bg zhiyuanBg" style="background:url('${basePath }/${not empty adv ? adv.cfgadvpic : 'static/assets/img/volunteer/zhiyuan-banner-2.jpg' }') no-repeat 50% 50%;">
    <div class="main-info-container">
        <div class="zhiyuan clearfix">
            ...
            <a href="http://www.gdzyz.cn/index?districtId=402800e245df56eb0145dfd7d6bb0043" target="_blank"><span class="enter">加入志愿者</span></a>
            <a href="http://www.gdzyz.cn/mission/index.do" target="_blank"><span class="enter">加入志愿活动</span></a>
        </div>
    </div>
</div>
<!--广告结束-->
