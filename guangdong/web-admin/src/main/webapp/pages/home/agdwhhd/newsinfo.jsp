 ...
 function  showInfoList(data) {
     if(data.code == 0 && data.rows.length > 0){
         ...
         for(var i in data.rows){
             ...
             infoHtml+='<li><a href="${basePath }/agdwhhd/newsinfo?id='+model.clnfid+'">'+model.clnftltle+'</a><p class="time">'+moment(model.clnfcrttime).format("YYYY-MM-DD")+'</p></li>';
          }
				...
				<c:forEach items="${loadent }" var="loadents" varStatus="s">
				 <div class="video">
                    ...
                    <video width="800" height="525" poster="${imgServerAddr }/${loadents.deourl}" controls  oncontextmenu="return false">
                      ...
                      &lt;%&ndash; <source type="video/mp4" src="${basePath }/${loadents.enturl}" /> &ndash;%&gt;
                    </video>
