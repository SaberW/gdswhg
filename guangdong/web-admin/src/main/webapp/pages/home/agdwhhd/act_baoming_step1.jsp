    ...
    <div class="dialog-signUP-content clearfix">
        <div class="order-msg">
            ...
            <div class="form-list">
                ...
                <p><span>手机号码：</span><input type="text" value="${wbgx_sessUserKey.mobile }" maxlength="11" id="orderphoneno" name="orderphoneno" readonly="readonly"><span class="color">*必填项</span></p>
                <p><span>姓名：</span><input type="text" value="${wbgx_sessUserKey.name }" placeholder="请输入订票人名称" maxlength="30" id="ordername" name="ordername"><span class="color">*必填项</span></p>
