...
<form id="whgff" class="whgff" method="post" action="${basePath}/admin/yunwei/whpp/add">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="name" style="width:600px; height:32px" data-options="required:true, validType:'length[1,100]'"></div>
    </div>

    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red">*</label>简称：</div>
        <div class="whgff-row-input"><input class="easyui-textbox" name="shortname" style="width:300px; height:32px" data-options="required:true, validType:'length[1,100]'"></div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="bgcolour" style="width:300px; height:32px" data-options="prompt:'背景颜色格式:#ffffff',required:false, validType:'length[1,100]'"></div>
    </div>
