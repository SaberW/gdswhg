...
<div id="whgdg-opt" style="display: none;">
    ...
    <shiro:hasPermission name="${resourceid}:add"><a href="javascript:void(0)" validKey="rmstate" validVal="0" class="easyui-linkbutton"  plain="true" method="toAudit">审核</a></shiro:hasPermission>
</div>
<!-- 操作按钮-END -->
<script>
