...
<body>
    ...
    <script type="text/javascript">
        ...
        function createSeats(seats) {
            ...
            subObject1.appendTo(object);
            var subObject2 = $('<div class="whgff-row-input" style="width: 70% !important;">');
            subObject2.append('<input class="easyui-textbox" id="seats" name="seats" style="width:200px; height:32px" data-options="validType:\'length[1,5]\', required:true, readonly:'+(sellticket==3?"true":"false")+'"  value="'+seats+'">');
            subObject2.appendTo(object);
            object.appendTo("#whgff");
            $.parser.parse("#whgff");
        }
