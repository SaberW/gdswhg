...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
       ...
       <div class="whgff-row-input">
           <select class="easyui-combobox" name="cultid" style="width:500px; height:32px" readonly="readonly"
    ...
    <%--<div class="whgff-row">--%>
        ...
        <%--&lt;%&ndash;<div class="whgff-row-input">--%>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-combobox" name="ebrand" value="${act.ebrand}" style="height:35px;width: 500px" readonly="readonly"
