...
<form id="whgff" class="whgff" method="post" enctype="multipart/form-data" >
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-combobox" name="mlproqy" style="height:35px;width: 600px" value="${ml.mlproqy}"
                                            data-options="multiple:true,editable:false,required:true, valueField:'id',textField:'text',prompt:'名录项目区域', data:WhgSysData.getTypeData('6')"/></div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <textarea id="value_catalog" style="display: none;">${ml.mlprodetail}</textarea>
        </div>
    </div>
