...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <select id="exhkey" class="easyui-combobox" style="width:600px; height:32px" validType="notQuotes"
                    data-options="multiple:true, valueField:'text', textField:'text',  data:WhgComm.getSzzgKey()" ></select>
            (多于2个关键字之间用半角逗号分隔)
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-textbox" name="exhcoorganizer" value="${exhi.exhcoorganizer}" style="width:600px; height:32px" data-options="required:false, validType:'length[0,500]'">
            <span>（如需输入多个，请用英文逗号隔开！）</span>
        </div>
    ...
    <div class="whgff-row">
        <div class="whgff-row-label"><label style="color: red"></label>承办单位：</div>
        <div class="whgff-row-input"><input class="easyui-textbox" name="exhcborganizer" value="${exhi.exhcborganizer}" style="width:600px; height:32px" data-options="required:false, validType:'length[0,500]'">
            <span>（如需输入多个，请用英文逗号隔开！）</span>
        </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <textarea id="value_catalog" style="display: none;">${exhi.exhdesc}</textarea>
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    ue_catalog.ready(function () {
        ue_catalog.setContent($("#value_catalog").val());
    });
    $(function () {

        $("#exhkey").combobox('setValue', "${exhi.exhkey}");
        ...
        $('#whgff').form({
            ...
            onSubmit : function(param) {
                ...
                param.exhkey = $("#exhkey").combobox('getText');
                return _valid;
            },
