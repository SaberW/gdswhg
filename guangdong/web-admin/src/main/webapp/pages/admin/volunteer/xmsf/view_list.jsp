...
<table id="whgdg" title="项目示范" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:false, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', url:'${basePath}/admin/volun/findpro'">
    <thead>
    <tr>
        <th data-options="field:'ck', checkbox:true"></th>
        <th data-options="field:'zyfcxmshorttitle'">标题</th>
        <th data-options="field:'zyfcxmpic', formatter:WhgComm.FMTImg">图片</th>
        <%--<th data-options="field:'zyfcxmpnum', width:160">志愿者数量</th>--%>
        <th data-options="field:'zyfcxmanum'">服务人数量</th>
        <th data-options="field:'zyfcxmssdw'">实施单位</th>
        <%--<th data-options="field:'zyfcxmsstime', width:100, formatter:WhgComm.FMTDateTime">实施时间</th>--%>
        <th data-options="field:'zyfcxmstate', formatter:traStateFMT">状态</th>
