...
<table id="whgdg" title="志愿培训管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:false, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', url:'${basePath}/admin/volun/findVolun'">
    <thead>
    <tr>
    	<th data-options="field:'ck', checkbox:true"></th>
        <th data-options="field:'zypxtype', sortable: true,formatter:WhgComm.FMTTrainType,formatter:function(val,row,index){ return WhgSysData.FMT(val, WhgSysData.getTypeData('12'));}">分类</th>
        <th data-options="field:'zypxshorttitle', sortable: true">列表短标题</th>
        <th data-options="field:'zypxfrom', sortable: true">来源</th>
        <th data-options="field:'zypxpic', formatter:WhgComm.FMTImg">列表图</th>
        <th data-options="field:'zypxstate', formatter:traStateFMT">状态</th>
