...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-datetimebox" id="zyfcxmsstime" name="zyfcxmsstime" value='<fmt:formatDate value="${xminfo.zyfcxmsstime}" pattern="yyyy-MM-dd HH:mm:ss" />' style="width: 300px;;height:35px;" data-options="editable:false, required:true" />
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-numberspinner" id="zyfcxmpnum" name="zyfcxmpnum" data-options="min:0" value="${xminfo.zyfcxmpnum}" style="width:500px;height:35px;" />
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-numberspinner" id="zyfcxmanum" name="zyfcxmanum" data-options="min:0" value="${xminfo.zyfcxmanum}" style="width:500px;height:35px;" />
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <textarea id="value_zyfcxmcontent" style="display: none;">${xminfo.zyfcxmcontent}</textarea>
        </div>
    </div>
</form>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        mydescUE.ready(function(){  mydescUE.setContent($("#value_zyfcxmcontent").val()) });
