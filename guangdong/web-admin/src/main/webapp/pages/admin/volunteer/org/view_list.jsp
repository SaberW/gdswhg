...
<table id="whgdg" title="志愿优秀组织" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:false, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', url:'${basePath}/admin/volun/findexce'">
    <thead>
    <tr>
        <th data-options="field:'ck', checkbox:true"></th>
        <th data-options="field:'zyfczzshorttitle'">列表短标题</th>
        <th data-options="field:'zyfczzpic',formatter:WhgComm.FMTImg">列表图片</th>
        <th data-options="field:'zyfczzpnum',sortable:true">志愿者数量</th>
        <th data-options="field:'zyfczzanum',sortable:true">活动数量</th>
        <th data-options="field:'zyfczzscope'">服务地区</th>
        <th data-options="field:'zyfczzfwtime'">服务时间(小时)</th>
        <th data-options="field:'zyfczzstate', formatter:traStateFMT ">状态</th>
