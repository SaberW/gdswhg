...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-numberspinner" id="zyfcxmpnum" name="zyfcxmpnum" data-options="min:0" style="width:500px;height:35px;" />
        </div>
    </div>
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-numberspinner" id="zyfcxmanum" name="zyfcxmanum" data-options="min:0" style="width:500px;height:35px;" />
        </div>
    </div>
