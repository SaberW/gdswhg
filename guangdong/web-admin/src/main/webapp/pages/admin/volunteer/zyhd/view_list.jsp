...
<table id="whgdg" title="项目示范" class="easyui-datagrid" style="display: none"
    ...
    <tr>
        ...
        <th data-options="field:'zyhdtitle',sortable:true">标题</th>
        <th data-options="field:'zyhdpic',formatter:WhgComm.FMTImg">列表图</th>
        <th data-options="field:'zyhdarea',sortable:true,formatter:FMTArea">志愿活动区域</th>
        <th data-options="field:'zyhdtype',sortable:true, formatter:FMTType">类型</th>
        <th data-options="field:'zyhdscope',sortable:true">服务地区</th>
        <%--<th data-options="field:'zyhdsdate', width:100, formatter:WhgComm.FMTDateTime">活动开始时间</th>--%>
        <th data-options="field:'zyhdstate', formatter:traStateFMT">状态</th>
