...
<table id="whgdg" title="先进个人管理" class="easyui-datagrid" style="display: none"
       data-options="fit:true, striped:true, rownumbers:true, fitColumns:false, singleSelect:false, checkOnSelect:true, selectOnCheck:true, pagination:true, toolbar:'#whgdg-tb', url:'${basePath}/admin/volun/findPerson'">
    <thead>
    <tr>
        <th data-options="field:'ck', checkbox:true"></th>
        <th data-options="field:'zyfcgrshorttitle'">列表短标题</th>
        <th data-options="field:'zyfcgrjoinact'">参与活动</th>
        <th data-options="field:'zyfcgrpic',formatter:WhgComm.FMTImg">列表图片</th>
        <th data-options="field:'zyfcgrzc'">文艺专长</th>
        <th data-options="field:'zyfcgrstate', formatter:traStateFMT ">状态</th>
