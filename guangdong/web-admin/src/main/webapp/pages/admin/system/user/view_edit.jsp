...
<form id="whgff" class="whgff" method="post">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input"><input class="easyui-passwordbox" id="password1" value="${adminuser.epms}" name="password1" style="width:300px; height:32px" data-options="prompt:'请输入管理员密码',required:true,validType:['pwCheck']"></div>
    </div>
