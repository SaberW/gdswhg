...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row" refField="clnflink">
        <div class="whgff-row-label">链接地址：</div>
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="link" value="${info.link}" style="width:600px; height:32px" data-options="required:false,validType:'url',prompt:'请输入连接地址,如：http://yoursite.com/'">
        </div>
    </div>
...
<script>
    ...
    var cfgRefFields = {
        ...
        ids_4 : ["clnftltle", "clnfintroduce","clnfauthor","clnfsource","clnfdetail","clnfkey","clnfcrttime","clnflink"],
        ids_5 : ["clnftltle", "clnfintroduce","clnfauthor","clnfsource","clnfdetail","clnfkey","clnfcrttime","clnflink"],
        ids_6 : ["clnftltle", "clnfdetail"],
        ids_default : [
            "clnftltle", //栏目内容标题
            "clnfsource", //栏目内容来源
            "clnfauthor", //作者
