...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <textarea id="value_description" style="display: none;">${whgVen.description}</textarea>
        </div>
    </div>
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            ...
            <textarea id="value_facilitydesc" style="display: none;">${whgVen.facilitydesc}</textarea>
        </div>
    </div>
</form>
