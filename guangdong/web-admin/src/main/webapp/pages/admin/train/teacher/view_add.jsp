...
<form id="whgff" method="post" class="whgff">
    ...
    <div class="whgff-row">
        ...
        <div class="whgff-row-input">
            <input class="easyui-textbox" name="teacherintroduce" value="${tea.teacherintroduce}" style="width:500px; height:100px" data-options="multiline:true, required:true,validType:['length[1,1000]'],prompt:'请填写老师简介'">
        </div>
    </div>
