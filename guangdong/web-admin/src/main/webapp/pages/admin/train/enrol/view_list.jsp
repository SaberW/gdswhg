        ...
        <div title="录取列表" style="overflow:auto;padding:5px;display:none;" >
            <table id="whgdg1" title="${pageTitle}" class="easyui-datagrid" style="display: none"
                ...
                <tr>
                    ...
                    <th data-options="field:'crttime', width:160, formatter:WhgComm.FMTDateTime">报名时间</th>
                    <th data-options="field:'state', width:160, formatter:WhgComm.FMTBmState" >状态</th>
                    <th data-options="field:'_opt', width:320, formatter:WhgComm.FMTOpt, optDivId:'whgdg-opt1'">操作</th>
                </tr>
                </thead>
            </table>
        </div>
...
<div id="whgdg-tb" style="display: none;">
    ...
    <div class="whgdg-tb-srch">
        ...
        <a id="exportLink" href="javascript:;" class="easyui-linkbutton" iconCls="icon-add" style="float: right;margin-right: 20px">导出Excel</a>
...
<div id="whgdg-opt" style="display: none;">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="state" validVal="3" method="viewCause">查看操作原因</a>
...
<div id="whgdg-opt1" style="display: none;">
    ...
    <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="state" validVal="5" method="showViewCause">查看操作原因</a>
    <a href="javascript:void(0)" class="easyui-linkbutton" plain="true" validKey="state" validVal="6" method="sign">签到</a>
</div>
<!-- 操作按钮-END -->
...
<div id="whgwin-sign" style="display: none">
    <%--<form id="whgff_sign" class="whgff" method="post">
        <div class="whgff-row">
           &lt;%&ndash; <div class="whgff-row-label" style="width: 30%"><i>*</i>课程信息：</div>
            <div class="whgff-row-input" style="width: 70%">&ndash;%&gt;
                &lt;%&ndash;<select class="easyui-combogrid" id="courseid" name="courseid" style="height: 35px; width: 90%" data-options="editable:false,required:true"></select>&ndash;%&gt;
                <table id="courseid"></table>
           &lt;%&ndash; </div>&ndash;%&gt;
        </div>
    </form>--%>
...
<script>
    ...
    function sign(idx){
        ...
        $('#whgwin-sign').dialog({
            ...
            onOpen: function () {
                $("#course").datagrid({
                    url: '${basePath}/admin/train/course/srchOne?traid=${id}&userid='+row.userid,
                });
            }
        });
