		...
		<div class="header-nav">
			...
			<div class="loginIn">
				 <span class="userName"><i></i><a href="${basePath }/center/userInfo">
					 <c:choose>
					 	<c:when test="${not empty wbgx_sessUserKey}" >
					 		${wbgx_sessUserKey.nickName }
					 		<span class="comm_alert"></span>
					 	</c:when>
					 	<c:otherwise><a href="${apiWbgx}${apiSite}/login" class="btn">登录</a></c:otherwise>
					 </c:choose>
				</a></span> 
				...
				<c:choose>
					 	...
					 	<c:otherwise><a href="${apiWbgx}${apiSite}/regist" id="regist" class="btn">注册</a></c:otherwise>
				</c:choose>
				</a></span> 
			</div>
