...
<li<c:if test="${reqPath == 'center/userInfo2'   }"> class="active"</c:if>><a href="${basePath }/center/userInfo"><em class="ico i-1"></em>基本信息</a></li>
<!-- <li><a href="order.html"><em class="ico i-2"></em>我的订单</a></li> -->
<li<c:if test="${reqPath == 'center/activity'   }"> class="active"</c:if>><a target="_blank" href="${apiWbgx}${apiSite}/center/activity" refuid="refuid" reftype="1"><em class="ico i-6"></em>我的活动</a></li>
<li<c:if test="${reqPath == 'center/curriculum' }"> class="active"</c:if>><a target="_blank" href="${apiZxpx}${apiSite}/usercenter/myTrain" refuid="refuid" reftype="2"><em class="ico i-3"></em>我的课程</a></li>
<li<c:if test="${reqPath == 'center/venueorder' }"> class="active"</c:if>><a target="_blank" href="${apiWbgx}${apiSite}/center/venue" refuid="refuid" reftype="3"><em class="ico i-1"></em>我的场馆</a></li>
...
>
	<a href="${apiWbgx}${apiSite}/center/safely" refuid="refuid" reftype="6"><em class="ico i-5"></em>安全设置</a>
</li>
