	...
	<div class="main clearfix">
		...
		<div class="rightMain">
			<div class="sysType clearfix">
				<!-- 首页注册登陆部分 -->
				<c:if test = "${empty wbgx_sessUserKey }">
				<div class="loginCont">
					<a href="${basePath }/login" class="btn">登录</a>
					<a href="${basePath}/toregist" id="regist"  class="btn">注册</a>
				</div>
				</c:if>
				<c:if test = "${not empty wbgx_sessUserKey }">
					<div class="loginIn"> 
						<span class="userName"><i></i><a href="${basePath }/center/userCenter">${wbgx_sessUserKey.nickName}</a></span>
