...
public class UserService {
     ...
     * @throws Exception
     */
    public PageInfo<WhUser_old> t_srchList4p(HttpServletRequest request, WhUser_old whuser) throws Exception {
        ...
        List<WhUser_old> list = this.userMapper.selectByExample(example);
        return new PageInfo<WhUser_old>(list);
    }
     ...
     * @throws Exception
     */
    public WhUser_old t_srchOne(String id) throws Exception {
     ...
     * @throws Exception
     */
    public WhUser_old t_edit(WhUser_old whuser, WhgSysUser sysUser) throws Exception {
     ...
     * @return
     */
    public List<WhUser_old> getList() {
     ...
     * @throws Exception
     */
    public Object addUser(WhUser_old whuser) {
        try {
     ...
     * 修改用户信息
     */
    public Object modifyUser(WhUser_old whuser) {
    ...
    public Object findPage(int page, int rows) throws Exception {
        ...
        // 取分页信息
        PageInfo<WhUser_old> pageInfo = new PageInfo<WhUser_old>(list);
    ...
    public Object loadUser(int page, int rows, WebRequest request) throws Exception {
        ...
        PageInfo<WhUser_old> pinfo = new PageInfo<WhUser_old>(list);
     ...
     * @param user
     */
    public WhUser_old checkUserReal(WhUser_old user) throws Exception {
