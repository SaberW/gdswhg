...
public class RegistService {
	 ...
	 * 根据微信三方登录的wxopenid查询
	 */
	public List<WhUser_old> getWxUser(String wxopenid)throws Exception{
	...
	public Object saveRegist(WhUser_old whuser)throws Exception{
		Example example = new Example(WhUser_old.class);
	 ...
	 * 根据QQ三方登录的openid查询
	 */
	public List<WhUser_old> getUserList(String openid)throws Exception{
		Example example = new Example(WhUser_old.class);
	 ...
	 * 根据微博三方登录的wid查询
	 */
	public List<WhUser_old> getWbList(String wid)throws Exception{
		Example example = new Example(WhUser_old.class);
	 ...
	 * @return
	 */
	public Object saveRegist2(WhUser_old whuser)throws Exception {
