...
public class CgfwService {
     ...
     * @throws Exception
     */
    public WhgVenRoomOrder saveUserVenroomtimeInfo(String roomtimeid, WhUser_old  user, String userphone, String username, String purpose) throws Exception{
     ...
     * 验证用户预订时段
     */
    public void testUserVenroomtimeInfo(WhUser_old  user, String roomtimeid, String userphone, String username, String purpose) throws Exception{
        WhgVenRoomTime time = this.findWhgVenroomtime4Id(roomtimeid);
        ...
        if (userphone == null){
            ...
            if (user.getPhone()==null || user.getPhone().isEmpty()){
                throw new Exception("errcode1005 ### 您还未绑定手机，请先去绑定手机！");
            }
        }
        ...
        if (time.getTimeday()!=null ){
            ...
            if (c.getTime().compareTo(new Date()) <0) {
                throw new Exception("errcode1006 ### 申请的活动室开放时间已过时");
            }
        }
