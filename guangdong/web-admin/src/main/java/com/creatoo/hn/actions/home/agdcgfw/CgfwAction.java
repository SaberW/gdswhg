...
public class CgfwAction {
	...
	public ModelAndView index_old(HttpServletRequest request){
    ...
    public ModelAndView index(HttpServletRequest request){
        ModelAndView view = new ModelAndView( "home/agdcgfw/index2" );
        view.addObject("apiRoot", commPropertiesService.getApiRoot());
        view.addObject("apiSite", commPropertiesService.getApiSite());
        return view;
    }
	 ...
	 * @return 场馆详情
	 */
	@RequestMapping("/venueinfo_old")
	public ModelAndView venueinfo_old(HttpServletRequest request){
    ...
    public ModelAndView venueinfo(HttpServletRequest request) {
        ModelAndView view = new ModelAndView("home/agdcgfw/venueinfo2");
        view.addObject("apiRoot", commPropertiesService.getApiRoot());
        view.addObject("apiSite", commPropertiesService.getApiSite());
