...
public class WhgTrainService {
     ...
     * @throws Exception
     */
    public void saveCourse(WhgTra tra, WhgSysUser user, WhgTraCourse traCourse) throws Exception{
        Date now = new Date();
    ...
    public ResponseBean t_edit(WhgTra tra, WhgSysUser sysUser, HttpServletRequest request) throws Exception {
        ...
        SimpleDateFormat sdf=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        if(tra.getIsmultisite() != null && tra.getIsmultisite() == 0 && request.getParameter("sin_starttime") != null && request.getParameter("sin_endtime") != null){
            tra.setStarttime(sdf.parse((String)request.getParameter("sin_starttime")));
            tra.setEndtime(sdf.parse((String)request.getParameter("sin_endtime")));
        }
        ...
        if(tra.getIsmultisite() != null && tra.getIsmultisite() == 2 && !"".equals(request.getParameter("starttime")) && !"".equals(request.getParameter("endtime"))){
