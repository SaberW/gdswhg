...
public class WhgExh {
     ...
     * @param exhkey 关键字
     */
    public void setExhkey(String exhkey) {
        this.exhkey = exhkey;
    }

    public String getExhcborganizer() {
        return exhcborganizer;
    }

    public void setExhcborganizer(String exhcborganizer) {
        this.exhcborganizer = exhcborganizer;
    }
}