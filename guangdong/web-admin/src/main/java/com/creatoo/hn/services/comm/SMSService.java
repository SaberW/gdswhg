...
public class SMSService {
    ...
    private static boolean gxtSendMessage2(String phoneNumber, String content){
        boolean isOK = false;
        String result= null;
        HttpURLConnection httpconn = null;
        BufferedReader rd = null;
        try {
            //动态获取配置参数
            //sms.url=http://service2.winic.org/Service.asmx/SendMessages?
            //sms.username=creatooszwhg_gds
            //sms.password=creatooszwhg369
            String gxtUrl = "http://service2.winic.org/Service.asmx/SendMessages?";
            String gxtId = "creatooszwhg_gds";
            String gxtPwd = "creatooszwhg369";
    ...
    public static void main(String[] args)throws  Exception {
        ...
        String content = "亲爱的${name}，您报名的培训：${title}，报名成功，请于${mstime}抵达${address}办理签到手续及参加测试（携带本人身份证原件、2张一寸彩照），未参加测试者视作弃权。";
        SMSService.gxtSendMessage2("13677392833", content);
    }
