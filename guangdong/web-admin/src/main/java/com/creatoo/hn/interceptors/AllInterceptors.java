...
public class AllInterceptors extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)throws Exception {
        ...
        request.getServletContext().setAttribute("apiRoot", commPropertiesService.getApiRoot());//外部接口地址
        request.getServletContext().setAttribute("apiStaticPath", commPropertiesService.getApiStaticPath());//外部接口静态资源地址
        request.getServletContext().setAttribute("apiSite", commPropertiesService.getApiSite());//站点标识
        request.getServletContext().setAttribute("apiWbgx", commPropertiesService.getApiWbgx());//外部供需
        request.getServletContext().setAttribute("apiZxpx", commPropertiesService.getApiZxpx());//在线培训
        //记录操作日志
