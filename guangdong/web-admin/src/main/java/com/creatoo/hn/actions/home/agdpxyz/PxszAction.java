...
public class PxszAction {
	...
	public ModelAndView teachlist(HttpServletRequest req, HttpServletResponse resp) {
		ModelAndView view = new ModelAndView("home/agdpxyz/teacher2");
		return view;
	}

	@RequestMapping("/teacher_old")
	@SuppressWarnings("unchecked")
	public ModelAndView teachlist_old(HttpServletRequest req, HttpServletResponse resp){
	...
	public ModelAndView teachdesc(String id) {
		ModelAndView view = new ModelAndView("home/agdpxyz/teacherinfo2");
		view.addObject("id", id);
		return view;
	}

	@RequestMapping("/teacherinfo_old")
	public ModelAndView teachdesc_old(String id){
