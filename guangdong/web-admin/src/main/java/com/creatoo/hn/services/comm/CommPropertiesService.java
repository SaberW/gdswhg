...
public class CommPropertiesService {
    ...
    private String apiWbgx;
    private String apiZxpx;
    ...
    public String getApiStaticPath() {
        return apiStaticPath;
    }

    public void setApiStaticPath(String apiStaticPath) {
        this.apiStaticPath = apiStaticPath;
    }
    ...
    public String getApiWbgx() {
        return apiWbgx;
    }

    public void setApiWbgx(String apiWbgx) {
        this.apiWbgx = apiWbgx;
    }

    public String getApiZxpx() {
        return apiZxpx;
    }

    public void setApiZxpx(String apiZxpx) {
        this.apiZxpx = apiZxpx;
    }
