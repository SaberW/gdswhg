...
public class PxyzAction {
	...
	public ModelAndView index(HttpServletRequest req){
		ModelAndView view = new ModelAndView( "home/agdpxyz/trainlist2" );
		return view;
	}

	@RequestMapping("/index_old")
	public ModelAndView index_old(HttpServletRequest req){
...
//			view.addObject("loadclazz", whent);
	...
	@RequestMapping("/trainlist_old")
	public ModelAndView trainlist_old(HttpServletRequest req){
		ModelAndView view = new ModelAndView( "home/agdpxyz/trainlist" );
		try {
			//获取请求参数
			Map<String, Object> param = ReqParamsUtil.parseRequest(req);
	...
	public ModelAndView traininfo(String traid) {
		ModelAndView view = new ModelAndView("home/agdpxyz/traininfo2");
		view.addObject("traid", traid);
		return view;
	}

	@RequestMapping("/traininfo_old")
	public ModelAndView traininfo_old(String traid){
